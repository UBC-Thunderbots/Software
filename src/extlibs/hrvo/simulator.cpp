...
std::size_t Simulator::addAgent(const Vector &position, std::size_t goalNo)
{
    if (defaults_ == NULL)
    {
...
std::size_t Simulator::addAgent(const Vector &position, std::size_t goalNo,
                                ...
                                const Vector &velocity, float orientation)
{
...
Vector Simulator::getGoalPosition(std::size_t goalNo) const
{
...
void Simulator::setAgentGoalPosition(std::size_t agentNo, Vector position)
{
...
void Simulator::setAgentPosition(std::size_t agentNo, const Vector &position)
{
...
void Simulator::setAgentVelocity(std::size_t agentNo, const Vector &velocity)
{
