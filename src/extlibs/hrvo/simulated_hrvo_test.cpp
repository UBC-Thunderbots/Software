...
//    auto enemy_robots = TestUtil::createStationaryRobotStatesWithId({Point(1, 0)});
    ...
    auto enemy_robots = TestUtil::createStationaryRobotStatesWithId(
            {Point(front_wall_x, 0.0), Point(front_wall_x, robot_y_delta), Point(front_wall_x, 2 * robot_y_delta),
             Point(front_wall_x + gate_1, 0.0), Point(front_wall_x + gate_1, -robot_y_delta),
             Point(front_wall_x + gate_1, -2 * robot_y_delta), Point(front_wall_x + gate_2, 0.0),
             Point(front_wall_x + gate_2, robot_y_delta), Point(front_wall_x + gate_2, 2 * robot_y_delta),
