...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="The absolute path to the .csv file which includes the robot information. File should be generated by "
             "HRVO simulator.",
    )
    parser.add_argument(
        "-s",
        ...
        dest="save_gif",
        action="store_true",
        help="If arg passed, animation will be saved as a GIF at the same directory as the .csv file.",
    )
