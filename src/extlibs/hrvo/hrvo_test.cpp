...
{
	Robot friendly_robot_1 = Robot(1, Point(3, 0), Vector(0.5, 0.5), Angle(), AngularVelocity(), Timestamp());
	Robot friendly_robot_2 = Robot(0, Point(), Vector(), Angle(), AngularVelocity(), Timestamp());
	Robot friendly_robot_3 = Robot(3, Point(-0.5, -0.5), Vector(), Angle::fromDegrees(179), AngularVelocity(), Timestamp());
	std::vector<Robot> friendly_robots = { friendly_robot_1, friendly_robot_2, friendly_robot_3 };

	Robot enemy_robot_1 = Robot(5, Point(-0.5, 0.2), Vector(1, 0), Angle(), AngularVelocity::fromRadians(1), Timestamp::fromMilliseconds(100));
	Robot enemy_robot_2 = Robot(0, Point(), Vector(0.5, 0.7), Angle::fromDegrees(358), AngularVelocity(), Timestamp());
	Robot enemy_robot_3 = Robot(2, Point(), Vector(), Angle::fromDegrees(30), AngularVelocity(), Timestamp());
	Robot enemy_robot_4 = Robot(4, Point(-3, 0), Vector(-1, 0), Angle(), AngularVelocity(), Timestamp::fromMilliseconds(5));
	std::vector<Robot> enemy_robots = { enemy_robot_1, enemy_robot_2, enemy_robot_3, enemy_robot_4 };
...
{
	Robot friendly_robot_1 = Robot(4, Point(), Vector(0.2, -0.5), Angle(), AngularVelocity(), Timestamp());
	Robot friendly_robot_2 = Robot(1, Point(0.1, -0.1), Vector(-0.5, -0.5), Angle::fromDegrees(-30), AngularVelocity(), Timestamp());
	Robot friendly_robot_3 = Robot(6, Point(), Vector(), Angle::fromDegrees(20), AngularVelocity(), Timestamp::fromSeconds(1));
	std::vector<Robot> friendly_robots = { friendly_robot_1, friendly_robot_2, friendly_robot_3 };

	Robot enemy_robot_1 = Robot(6, Point(), Vector(-0.8, -0.8), Angle(), AngularVelocity(), Timestamp());
	Robot enemy_robot_2 = Robot(2, Point(0.3, 4.5), Vector(), Angle(), AngularVelocity::half(), Timestamp());
	Robot enemy_robot_3 = Robot(1, Point(1, 1.2), Vector(1.3, 1.9), Angle(), AngularVelocity(), Timestamp::fromMilliseconds(10));
	std::vector<Robot> enemy_robots = { enemy_robot_1, enemy_robot_2, enemy_robot_3 };
	...
	friendly_robots.pop_back();
	Robot friendly_robot_4 = Robot(5, Point(), Vector(), Angle(), AngularVelocity(), Timestamp());
	friendly_robots.push_back(friendly_robot_4);
...
{
	Robot friendly_robot_1 = Robot(0, Point(1, 3), Vector(0, -0.5), Angle(), AngularVelocity(), Timestamp());
	Robot friendly_robot_2 = Robot(2, Point(), Vector(), Angle::fromDegrees(15), AngularVelocity(), Timestamp());
	Robot friendly_robot_3 = Robot(1, Point(1, 1), Vector(0, 0.1), Angle(), AngularVelocity(), Timestamp());
	std::vector<Robot> friendly_robots = { friendly_robot_1, friendly_robot_2, friendly_robot_3 };

	Robot enemy_robot_1 = Robot(3, Point(), Vector(), Angle::quarter(), AngularVelocity(), Timestamp());
	Robot enemy_robot_2 = Robot(0, Point(0.3, 0.3), Vector(), Angle(), AngularVelocity::half(), Timestamp());
	Robot enemy_robot_3 = Robot(2, Point(), Vector(0.1, 0.9), Angle(), AngularVelocity(), Timestamp());
	std::vector<Robot> enemy_robots = { enemy_robot_1, enemy_robot_2, enemy_robot_3 };
	...
	enemy_robots.pop_back();
	enemy_robots.pop_back();
	Robot enemy_robot_4 = Robot(6, Point(), Vector(1.2, 2.1), Angle(), AngularVelocity(), Timestamp());
	enemy_robots.push_back(enemy_robot_4);
...
{
	Robot friendly_robot_1 = Robot(3, Point(), Vector(0, 0.2), Angle::half(), AngularVelocity(), Timestamp());
	Robot friendly_robot_2 = Robot(0, Point(0.6, 3), Vector(2.1, 0), Angle(), AngularVelocity(), Timestamp());
	Robot friendly_robot_3 = Robot(5, Point(), Vector(), Angle(), AngularVelocity(), Timestamp::fromMilliseconds(105));
	std::vector<Robot> friendly_robots = { friendly_robot_1, friendly_robot_2, friendly_robot_3 };

	Robot enemy_robot_1 = Robot(1, Point(0.1, 0.2), Vector(3, 1), Angle(), AngularVelocity::fromDegrees(12), Timestamp());
	Robot enemy_robot_2 = Robot(3, Point(), Vector(), Angle(), AngularVelocity(), Timestamp::fromMilliseconds(2));
	Robot enemy_robot_3 = Robot(2, Point(), Vector(), Angle(), AngularVelocity(), Timestamp());
	std::vector<Robot> enemy_robots = { enemy_robot_1, enemy_robot_2, enemy_robot_3 };
	...
	friendly_robots.pop_back();
	friendly_robots.pop_back();
	Robot friendly_robot_4 = Robot(1, Point(2.5, 2.5), Vector(0.1, 0.1), Angle(), AngularVelocity(), Timestamp());
	friendly_robots.push_back(friendly_robot_4);
