...
class Simulator
{
   public:
     ...
     */
    std::size_t addAgent(const Vector &position, std::size_t goalNo);
     ...
     * @return    The number of the agent.
     */
    std::size_t addAgent(const Vector &position, std::size_t goalNo, float neighborDist,
     ...
     */
    Vector getGoalPosition(std::size_t goalNo) const;
    ...
    void setAgentDefaults(float neighborDist, std::size_t maxNeighbors, float radius,
                          ...
                          float maxAccel         = std::numeric_limits<float>::infinity(),
                          const Vector &velocity = Vector(), float orientation = 0.0f);
    ...
    void setAgentGoalPosition(size_t agentNo, Vector position);
     ...
     */
    void setAgentPosition(std::size_t agentNo, const Vector &position);
     ...
     */
    void setAgentVelocity(std::size_t agentNo, const Vector &velocity);
