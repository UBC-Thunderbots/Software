...
{
    static void fieldAddLine(SSL_GeometryFieldSize *field, std::string name, float x1,
    ...
    static void fieldAddCircularArc(SSL_GeometryFieldSize *field, std::string name,
