...
//            TbotsProto::MaxAllowedSpeedMode::PHYSICAL_LIMIT, Angle::threeQuarter(),
//            TbotsProto::DribblerMode::INDEFINITE, TbotsProto::BallCollisionType::AVOID,
//            {AutoChipOrKickMode::AUTOCHIP, 2.5}, robot_constants, 3.0, false, 0.0,
//            std::optional<double>());
//
//
//    ASSERT_TRUE(move_primitive->has_move());
...
//    auto move_primitive = createMovePrimitive(
//            TestUtil::createMotionControl(Point(-5, 1)),
//            TbotsProto::MaxAllowedSpeedMode::STOP_COMMAND, Angle::threeQuarter(),
//            TbotsProto::DribblerMode::INDEFINITE, TbotsProto::BallCollisionType::AVOID,
//            {AutoChipOrKickMode::AUTOKICK, 3.5}, robot_constants, 3.0, false, 0.0,
//            std::optional<double>());
//
//    ASSERT_TRUE(move_primitive->has_move());
//    auto destination = move_primitive->move().motion_control().path().points().at(0);
