...
TbotsProto_PowerControl createNanoPbPowerControl(ChickerCommandMode chicker_command,
                                                 float kick_speed_m_per_s, float chip_distance_meters,
                                                 ...
                                                 TbotsProto_PowerControl_ChargeMode charge_mode)
{
    ...
    TbotsProto_PowerControl_ChickerControl chicker = TbotsProto_PowerControl_ChickerControl_init_default;
    switch (chicker_command) {
        case ChickerCommandMode::CHIP:
            control.chicker.which_chicker_command = TbotsProto_PowerControl_ChickerControl_chip_distance_meters_tag;
            chicker.chicker_command.chip_distance_meters = chip_distance_meters;
        case ChickerCommandMode::KICK:
            control.chicker.which_chicker_command = TbotsProto_PowerControl_ChickerControl_kick_speed_m_per_s_tag;
