...
TEST(PowerFrameMsgTest, google_to_nanopb)
{
    ...
    auto nanopb_control = createNanoPbPowerPulseControl(google_control, 0, 0, 0, 100);
    ...
    nanopb_control = createNanoPbPowerPulseControl(google_control, 0.3, 300, 0, 0);
    EXPECT_EQ(nanopb_control.chicker.which_chicker_command,
    ...
    nanopb_control = createNanoPbPowerPulseControl(google_control, 0.1, 3, 0, 0);
    EXPECT_EQ(nanopb_control.chicker.which_chicker_command,
    ...
    nanopb_control = createNanoPbPowerPulseControl(google_control, 10000, 10000, 0, 0);
    EXPECT_EQ(nanopb_control.chicker.which_chicker_command,
              TbotsProto_PowerPulseControl_ChickerControl_auto_chip_or_kick_tag);
    EXPECT_EQ(
        nanopb_control.chicker.chicker_command.auto_chip_or_kick.which_auto_chip_or_kick,
    ...
    nanopb_control = createNanoPbPowerPulseControl(google_control, 0, 0, 0, 200);
    EXPECT_EQ(nanopb_control.chicker.which_chicker_command,
              TbotsProto_PowerPulseControl_ChickerControl_auto_chip_or_kick_tag);
    EXPECT_EQ(
        nanopb_control.chicker.chicker_command.auto_chip_or_kick.which_auto_chip_or_kick,
