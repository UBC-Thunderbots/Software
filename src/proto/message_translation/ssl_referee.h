...
/**
 * @brief this maps a protobuf SSLProto::Referee_Command enum to its equivalent
 * internal type
...
/**
 * @brief this maps a protobuf SSLProto::Referee_Stage enum to its RefereeStage
 * equivalent
 */
...
/**
 * Converts a SSLProto::Referee protobuf Stage contained in the SSLProto::Referee
 * packet into a RefereeStage
 *
 * @param packet SSLProto::Referee protobuf
 *
