...
def start_interactive_cli():
    ...
    match category:
        case "Run thunderscope":
            ...
            extra_args.append(f"{THUNDERSCOPE_OPTIONS_MAP[launch]}")
            if launch == "Simulator":
                ask_for_interface = False
