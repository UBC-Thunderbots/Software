...
import {
  TopicListener,
  TopicListenerType,
} from '~/components/containers/TopicListener';
import { IROSOut } from '~/types/standardTopics';
import { LogMessage } from './LogMessage';

/**
 * Logging module. Displays the /rosout ROS topic, which is used by all nodes
...
export const Logger = () => {
  ...
  return (
    <Subscribe to={[TopicListener('/rosout')]}>{mapLogMessages}</Subscribe>
  );
};
