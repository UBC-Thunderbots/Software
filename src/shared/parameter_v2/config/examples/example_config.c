...
const ThunderbotsConfig_t* app_dynamic_parameters_create(void)
{
    ...
    BarConfig_t bar_config_init = {
        .bar_int  = app_dynamic_parameters_createIntegerParameter(3),
        .bar_bool = app_dynamic_parameters_createBoolParameter(false),
    };

    FooConfig_t foo_config_init = {
        .foo_int  = app_dynamic_parameters_createIntegerParameter(3),
...
{
    app_dynamic_parameters_destroyIntegerParameter(
    ...
    app_dynamic_parameters_destroyUnsignedIntegerParameter(
