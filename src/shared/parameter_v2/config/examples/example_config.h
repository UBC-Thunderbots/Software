...
typedef struct ExampleConfig_s
{
    ...
    const UnsignedIntegerParameter_t example_unsigned_int_param;
...
const ThunderbotsConfig_t* initAppDynamicParameters()
{
     ...
     *after malloc We copy all the values from the stack-allocated struct into the
...
// autogenerated
void deInitDyanmicParameters(ThunderbotsConfig_t* tbots_config)
{
