...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, WHEEL_BACK_LEFT_DIR_Pin|USER_LED_2_Pin|USER_LED_1_Pin|WIFI_RESET_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ID_SEL_2_Pin|ID_SEL_3_Pin|ID_SEL_4_Pin|DRIBBLER_RESET_Pin
                          |DRIBBLER_MODE_Pin|DRIVE_MODE_Pin;
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin */
  GPIO_InitStruct.Pin = IMU_INT1_Pin|WHEEL_FRONT_LEFT_FF1_Pin|WHEEL_FRONT_LEFT_FF2_Pin|ID_SEL_1_Pin;
  ...
  GPIO_InitStruct.Pin = WHEEL_BACK_RIGHT_FF1_Pin|WHEEL_BACK_RIGHT_FF2_Pin|WHEEL_FRONT_RIGHT_FF1_Pin|WHEEL_FRONT_RIGHT_FF2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = WHEEL_BACK_LEFT_DIR_Pin|USER_LED_2_Pin|USER_LED_1_Pin|WIFI_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
