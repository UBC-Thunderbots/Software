...
void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOE,
                      ID_SEL_2_Pin | ID_SEL_3_Pin | ID_SEL_4_Pin | DRIBBLER_RESET_Pin |
                          DRIBBLER_MODE_Pin | DRIVE_MODE_Pin | FAULT_PWR_BRD_Pin,
                      GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : PGPin PGPin PGPin PGPin
                             ...
                             PGPin PGPin */
    GPIO_InitStruct.Pin = DRIBBLER_FF1_Pin | DRIBBLER_FF2_Pin | GREEN_RGB_Pin |
                          BLUE_RGB_Pin | RED_RGB_Pin | CH_SEL_1_Pin | CH_SEL_2_Pin |
                          CH_SEL_3_Pin | CH_SEL_4_Pin | DONE_PWR_BRD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    /*Configure GPIO pins : PC8 PC9 PCPin PCPin
                             PCPin */
    GPIO_InitStruct.Pin =
        GPIO_PIN_8 | GPIO_PIN_9 | SD_DAT2_Pin | SD_DAT3_Pin | SD_CLK_Pin;
