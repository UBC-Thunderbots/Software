...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = DRIBBLER_TACHO_Pin|WHEEL_BACK_LEFT_TACHO_Pin|WHEEL_FRONT_LEFT_TACHO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = WHEEL_BACK_RIGHT_PWM_Pin|DRIBBLER_PWM_Pin|WHEEL_BACK_LEFT_PWM_Pin|WHEEL_FRONT_LEFT_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOD, DRIBBLER_TACHO_Pin|WHEEL_BACK_LEFT_TACHO_Pin|WHEEL_FRONT_LEFT_TACHO_Pin);
