...
void MX_HRTIM_Init(void)
{
    ...
    if (HAL_HRTIM_TimeBaseConfig(&hhrtim, HRTIM_TIMERINDEX_TIMER_B, &pTimeBaseCfg) !=
        HAL_OK)
    {
        Error_Handler();
    }
    ...
    if (HAL_HRTIM_WaveformTimerConfig(&hhrtim, HRTIM_TIMERINDEX_TIMER_B, &pTimerCfg) !=
        HAL_OK)
    {
        Error_Handler();
    }
    if (HAL_HRTIM_WaveformTimerConfig(&hhrtim, HRTIM_TIMERINDEX_TIMER_C, &pTimerCfg) !=
        HAL_OK)
    {
        Error_Handler();
    }
    ...
    if (HAL_HRTIM_TimeBaseConfig(&hhrtim, HRTIM_TIMERINDEX_TIMER_C, &pTimeBaseCfg) !=
        HAL_OK)
    {
        Error_Handler();
    }
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hrtimHandle)
{
    ...
    if (hrtimHandle->Instance == HRTIM1)
    {
        ...
        PA9     ------> HRTIM_CHC1
        */
        GPIO_InitStruct.Pin       = PIEZO_Pin | GENEVA_SPEED_Pin;
