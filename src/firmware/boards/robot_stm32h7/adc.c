...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    GPIO_InitStruct.Pin = ENCODER_BACK_LEFT_SIN_Pin|ENCODER_BACK_LEFT_COS_Pin|ENCODER_FRONT_LEFT_SIN_Pin|ENCODER_FRONT_LEFT_COS_Pin
                          |ENCODER_BACK_RIGHT_SIN_Pin|ENCODER_BACK_RIGHT_COS_Pin|HV_SENSE_PWR_BRD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(GPIOF, ENCODER_BACK_LEFT_SIN_Pin|ENCODER_BACK_LEFT_COS_Pin|ENCODER_FRONT_LEFT_SIN_Pin|ENCODER_FRONT_LEFT_COS_Pin
                          |ENCODER_BACK_RIGHT_SIN_Pin|ENCODER_BACK_RIGHT_COS_Pin|HV_SENSE_PWR_BRD_Pin);
