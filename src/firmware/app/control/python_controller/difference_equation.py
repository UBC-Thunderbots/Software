...
class DifferenceEquation:
    ...
    def __init__(self, tf_numerator_coefficients: list, tf_denominator_coefficients: list):
        ...
        self.__controller_rank = len(self.__denominator_coefficients)
        self.__input_coeffs_order = len(self.__numerator_coefficients)
    ...
    def tick(self, current_input):
        ...
        for i in range(1, self.__controller_rank):
