 ...
 *
 * @param set_speed [in] A function that can be called to set the current speed of the
 * dribbler
 * @param coast [in] A function that can be called to make the dribbler coast until
 * another operation is applied to it
 * @param get_temperature_deg_c [in] A function that can be called to get the temperature
 * of the dribbler, in degrees celsius
 *
 ...
 *       `create` function
 *
 * @param dribbler [in] The dribbler to destroy
 */
void app_dribbler_destroy(Dribbler_t* dribbler);

/**
 * Set the speed of the given dribbler
 * @param dribbler [in/out] The dribbler to set the speed of
 ...
 * @param dribbler [in/out] The dribbler to coast
 */
void app_dribbler_coast(Dribbler_t* dribbler);

/**
 * Get the temperature of the given dribbler
 * @param dribbler [in] The dribbler to get the temperature of
 *
