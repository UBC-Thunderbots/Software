 ...
 *
 * @param kick [in] A function that we can call to kick with the chicker with a given
 * speed, in meters per second
 * @param chip [in] A function that we can call to chip a given distance, in meters, with
 * the chicker. The distance parameter is the distance to the first bounce.
 * @param enable_autokick [in] A function that we can call to enable autokick on the
 ...
 * @param enable_autochip [in] A function that we can call to enable autochip on the
 ...
 * @param disable_autokick [in] A function that we can call to disable autokick
 * @param disable_autochip [in] A function that we can call to disable autochip
 *
 ...
 * @param chicker [in/out] The chicker to chip with
 ...
 * @param chicker [in/out] The chicker to enable autokick on
 ...
 * @param chicker [in/out] The chicker to enable autochip on
 ...
 * @param chicker [in/out] The chicker to disable autokick on
 */
void app_chicker_disableAutokick(Chicker_t* chicker);

/**
 * Disable autochip on the given chicker
 * @param chicker [in/out] The chicker to disable autochip on
 */
