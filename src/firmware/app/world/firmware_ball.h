 ...
 *       field)
 *
 * @param get_ball_position_x [in] A function that can be called to get the x-position of
 * the ball, in meters
 * @param get_ball_position_y [in] A function that can be called to get the y-position of
 * the ball, in meters
 * @param get_ball_velocity_x [in] A function that can be called to get the x-position of
 * the ball, in meters per second
 * @param get_ball_velocity_y [in] A function that can be called to get the y-position of
 * the ball, in meters per second
 *
 ...
 * @param ball [in] The ball to get the y-position for
 ...
 * @param ball [in] The ball to get the x component of velocity for
 ...
 * @param ball [in] The ball to get the y component of velocity for
