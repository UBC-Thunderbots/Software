 ...
 *
 * @param apply_wheel_force [in] A function that we can call to apply a force to this
 * wheel, in newtons
 * @param get_motor_speed_rpm [in] A function that we can call to get the speed of this
 * wheel, in RPM
 ...
 *       `create` function
 *
 * @param wheel [in] The wheel to destroy
 */
void app_wheel_destroy(Wheel_t* wheel);

/**
 * Apply the given force to the given wheel
 * @param wheel [in/out] The wheel to apply force to
 ...
 * @param wheel [in] The wheel to get the speed for
 *
 ...
 * @param wheel [in] The wheel to get the motor RPM for
 *
 ...
 * @param wheel [in/out] The wheel to allow to spin freely
 */
void app_wheel_coast(const Wheel_t* wheel);

/**
 * Brake this wheel
 * @param wheel [in/out] The wheel to brake
 */
void app_wheel_brake(const Wheel_t* wheel);

/**
 * Get the constants for the given wheel
 * @param wheel [in] The wheel to get the constants for
 *
