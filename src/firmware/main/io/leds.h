 ...
 */
typedef enum {
	LEDS_TEST_MODE_NORMAL, ///< LED 0 shows break beam status, LED 1 shows auto-chick armed, LED 2 off
	LEDS_TEST_MODE_CONSTANT, ///< LEDs show a fixed pattern
	LEDS_TEST_MODE_HALL, ///< LEDs show the states of a Hall sensor
	LEDS_TEST_MODE_ENCODER, ///< LEDs 0 and 1 show the states of an optical encoder, LED 2 off
} leds_test_mode_t;
