...
static void dribble_start(const primitive_params_t* params, void* void_state_ptr, FirmwareWorld_t* world)
{
...
static void dribble_tick(void* void_state_ptr,FirmwareWorld_t* world)
{
    ...
    app_bangbang_prepareTrajectoryMaxV(&Xprofile, state->destination[0] - pos[0], vel[0], 0,
                                       max_accel[0], 0.7f);
    ...
    BBProfile Yprofile;
    app_bangbang_prepareTrajectoryMaxV(&Yprofile, state->destination[1] - pos[1], vel[1], 0,
                                       max_accel[1], 0.7f);
