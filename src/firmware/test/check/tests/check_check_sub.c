...
START_TEST(test_fail_empty)
{
    ...
    /* plain fail() doesn't compile with xlc in C mode because of `, ## __VA_ARGS__'
     * problem */
...
{
    const char *s =
        "";
    const char *t =
        "";
...
{
    const char *s =
        "";
    const char *t =
        "";
...
START_TEST(test_segv)
{
    record_test_name(tcase_name());
    record_failure_line_num(__LINE__ -
                            4); /* -4 as the failure is reported at START_TEST() */
    raise(SIGSEGV);
}
END_TEST
...
START_TEST(test_mark_point)
{
    ...
    mark_point();
    record_failure_line_num(__LINE__ -
                            2); /* -2 as the failure is listed as from mark_point() */
    raise(SIGFPE);
...
START_TEST(test_invalid_set_fork_status)
{
    ...
    record_failure_line_num(__LINE__ -
                            9); /* -9 as the failure is reported at START_TEST() */
...
Suite *make_sub_suite(void)
{
...
#if HAVE_DECL_SETENV
    /* tc_timeout_env_scale_int tests have a timeout of 6 (time) * 2 (multiplier) = 12
     * seconds */
    ...
    /* tc_timeout_env_scale_double tests have a timeout of 0.9 (time) * 0.4 (multiplier) =
     * 0.36 seconds */
    ...
    /* tc_timeout_scale_double tests have a timeout of 4 (default) * 0.3 (multiplier)
     * = 1.6 second */
