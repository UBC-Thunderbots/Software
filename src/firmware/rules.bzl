def stm32h7_hal_library_files_genrule(name):
    ...
    native.genrule(
        ...
        cmd = "\n".join([
            ...
            "curl -L http://sw-center.st.com/packs/resource/firmware/stm32cube_fw_h7_v160.zip -o fw.zip",
            "mv fw.zip $@",
        ]),
    )
    ...
    native.genrule(
        ...
        cmd = "\n".join([
            ...
            "unzip -qo $< 'STM32Cube_FW_H7_V1.6.0/Drivers/*' 'STM32Cube_FW_H7_V1.6.0/Middlewares/*'",
            # Clear the locations we're going to put the files
            "rm -rf $(RULEDIR)/Drivers",
            "rm -rf $(RULEDIR)/Middlewares",
            # Move the files to the correct locations
            "mv STM32Cube_FW_H7_V1.6.0/Drivers $(RULEDIR)/",
            "mv STM32Cube_FW_H7_V1.6.0/Middlewares $(RULEDIR)/",
        ]),
    )
