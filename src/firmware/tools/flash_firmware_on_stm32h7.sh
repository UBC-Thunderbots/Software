#!/bin/bash
#
# This script allows the user to automatically flash a given binary to a ARM MCU over USB, all via OpenOCD
#
...
echo "Flashing $elf_file with config $OPENOCD_CFG_FILE"
