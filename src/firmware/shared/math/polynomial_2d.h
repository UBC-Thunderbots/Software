...
/**
 * Get value of the radius of curvature at any point along the 's' parameterized
 * polynomial2s
 *
 ...
 *
 * @param s [in] The parameterizaton value the polynomial will be evaluated at
 *
 * @return The radius of curvature of the polynomial at 's' [units of distance]
 */
