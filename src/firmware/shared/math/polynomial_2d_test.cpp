...
#include "firmware/shared/math/polynomial_1d.h"
    ...
    class Polynomial2dTest : public testing::Test
    {
       protected:
        ...
        static void expectArcLengthParametrizationsEqual(
            ArcLengthParametrization_t expected, ArcLengthParametrization_t actual,
            double tolerance = 10e-10)
        {
    ...
    TEST_F(Polynomial2dTest, get_value_0th_order_polynomial)
    {
        ...
        expectVector2dEqual({.x = -2, .y = 3},
                            shared_polynomial2d_getValueOrder0(poly, 0));
        expectVector2dEqual({.x = -2, .y = 3},
                            shared_polynomial2d_getValueOrder0(poly, 0.1));
        expectVector2dEqual({.x = -2, .y = 3},
                            shared_polynomial2d_getValueOrder0(poly, -0.1));
        expectVector2dEqual({.x = -2, .y = 3},
                            shared_polynomial2d_getValueOrder0(poly, 10));
        expectVector2dEqual({.x = -2, .y = 3},
                            shared_polynomial2d_getValueOrder0(poly, -10));
    }
    ...
    // ```
        // clang-format on
        float expected_t_values[17]          = {-6,   -5.25, -4.5, -3.75, -3.0, -2.25,
    ...
    TEST_F(Polynomial2dTest, get_position_at_arc_length_on_straight_line_1_values)
    {
        ...
        ArcLengthParametrization_t arc_length_parametrization = {
            .t_values          = t_values,
            .arc_length_values = arc_length_values,
            .num_values        = 1};
    ...
    TEST_F(Polynomial2dTest,
           get_position_on_arc_length_above_arc_lengths_in_parametrization)
    {
        Polynomial2dOrder1_t poly = {
            .x = {.coefficients = {1, 0.1}},
            .y = {.coefficients = {1, 0.1}},
    ...
    TEST_F(Polynomial2dTest,
           get_position_on_arc_length_below_arc_lengths_in_parametrization)
    {
        Polynomial2dOrder1_t poly = {
            .x = {.coefficients = {1, 0.1}},
            .y = {.coefficients = {1, 0.1}},
    ...
    TEST_F(Polynomial2dTest,
           get_position_at_arc_length_on_complex_line_multiple_divisions)
    {
        Polynomial2dOrder3_t poly = {
            .x = {.coefficients = {0.1 / 3, 1.5, -0.5, 70.1}},
            .y = {.coefficients = {-0.2 / 3, 19.1, -3, -3}},
    ...
    TEST_F(Polynomial2dTest,
           get_t_value_on_arc_length_above_arc_lengths_in_parametrization)
    {
        Polynomial2dOrder1_t poly = {
            .x = {.coefficients = {1, 0.1}},
            .y = {.coefficients = {1, 0.1}},
    ...
    TEST_F(Polynomial2dTest,
           get_t_value_on_arc_length_below_arc_lengths_in_parametrization)
    {
        Polynomial2dOrder1_t poly = {
            .x = {.coefficients = {1, 0.1}},
            .y = {.coefficients = {1, 0.1}},
