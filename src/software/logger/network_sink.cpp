...
//           log_msg_proto->ParseFromString(any.SerializeAsString());

           LOG(INFO) << "Printing message size " << log_msg_proto.get()->mutable_velocity_obstacles()->size();

//           std::string data_buffer;
//           log_msg_proto->SerializeToString(&data_buffer);

           serialized_proto_log_output->sendProto(serialized_proto);
...
{
    LOG(INFO) << " normal override NETWORK SINK";
