...
class LoggerSingleton
{
   public:
     ...
     */
    static void initializeLogger(const std::string& runtime_dir, const std::shared_ptr<ProtoLogger>& proto_logger)
    {
        static std::shared_ptr<LoggerSingleton> s(new LoggerSingleton(runtime_dir, proto_logger));
    }

   private:
    LoggerSingleton(const std::string& runtime_dir, const std::shared_ptr<ProtoLogger>& proto_logger)
    {
