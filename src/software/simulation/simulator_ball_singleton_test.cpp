...
{
    auto physics_world = std::make_unique<PhysicsWorld>(Field::createSSLDivisionBField(), std::make_shared<const SimulatorConfig>());
...
{
    auto physics_world_1 = std::make_unique<PhysicsWorld>(Field::createSSLDivisionBField(), std::make_shared<const SimulatorConfig>());
    ...
    auto physics_world_2 =
        std::make_unique<PhysicsWorld>(Field::createSSLDivisionBField(), std::make_shared<const SimulatorConfig>());
