...
void ThreadedSimulator::setYellowRobotPrimitive(RobotId id, unsigned int primitive_index, const primitive_params_t& params) {
    std::scoped_lock lock(simulator_mutex);
    simulator.setYellowRobotPrimitive(id, primitive_index, params);
}

void ThreadedSimulator::setBlueRobotPrimitive(RobotId id, unsigned int primitive_index, const primitive_params_t& params) {
    std::scoped_lock lock(simulator_mutex);
