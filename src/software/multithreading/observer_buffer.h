 ...
 */
template <typename T>
class ObserverBuffer : public Observer<T>
{
   public:
    ObserverBuffer(size_t buffer_size = DEFAULT_BUFFER_SIZE);
    ...
    virtual ~ObserverBuffer() = default;
...
#include "software/multithreading/observer_buffer.tpp"
