...
class Simulator
{
   public:
    ...
    /**
     * \brief  Performs a simulation step; updates the orientation, position, and velocity
     ...
     * \param[in]  agentNo  The number of the agent whose maximum acceleration is to be
     * retrieved. \return     The present maximum acceleration of the agent.
     */
    float getAgentMaxAccel(std::size_t agentNo) const;

    /**
     * \brief      Returns the maximum neighbor count of a specified agent.
     * \param[in]  agentNo  The number of the agent whose maximum neighbor count is to be
     * retrieved. \return     The present maximum neighbor count of the agent.
     */
     ...
     * retrieved. \return     The present maximum speed of the agent.
     */
    float getAgentMaxSpeed(std::size_t agentNo) const;

    /**
     * \brief      Returns the maximum neighbor distance of a specified agent.
     * \param[in]  agentNo  The number of the agent whose maximum neighbor distance is to
     * be retrieved. \return     The present maximum neighbor distance of the agent.
     */
     ...
     *
     * \param[in]  agentNo  The number of the agent whose preferred speed is to be
     * retrieved. \return     The present preferred speed of the agent.
     */
     ...
     * \param[in]  agentNo  The number of the agent whose progress towards its goal is to
     * be retrieved. \return     True if the agent has reached its goal; false otherwise.
     */
     ...
     *
     * \param[in]  agentNo  The number of the agent whose uncertainty offset is to be
     * retrieved. \return     The present uncertainty offset of the agent.
     */
     ...
     * agent. \param[in]  maxNeighbors       The default maximum neighbor count of a new
     * agent. \param[in]  radius             The default radius of a new agent. \param[in]
     * goalRadius         The default goal radius of a new agent. \param[in]  prefSpeed
     * The default preferred speed of a new agent. \param[in]  maxSpeed           The
     * default maximum speed of a new agent. \param[in]  uncertaintyOffset  The default
     * uncertainty offset of a new agent. \param[in]  maxAccel           The default
     * maximum acceleration of a new agent. \param[in]  velocity           The default
     * initial velocity of a new agent. \param[in]  orientation        The default initial
     * orientation (in radians) of a new agent.
     */
     ...
     * \param[in]  agentNo     The number of the agent whose goal radius is to be
     * modified. \param[in]  goalRadius  The replacement goal radius.
     */
     ...
     * \param[in]  agentNo   The number of the agent whose maximum acceleration is to be
     * modified. \param[in]  maxAccel  The replacement maximum acceleration.
     */
     ...
     * to be modified. \param[in]  maxNeighbors  The replacement maximum neighbor count.
     */
     ...
     * \param[in]  agentNo   The number of the agent whose maximum speed is to be
     * modified. \param[in]  maxSpeed  The replacement maximum speed.
     */
     ...
     * is to be modified. \param[in]  neighborDist  The replacement maximum neighbor
     * distance.
     */
     ...
     * \param[in]  agentNo      The number of the agent whose orientation is to be
     * modified. \param[in]  orientation  The replacement orientation (in radians).
     */
     ...
     *
     * \param[in]  agentNo    The number of the agent whose preferred speed is to be
     * modified. \param[in]  prefSpeed  The replacement preferred speed.
     */
     ...
     *             of a differential drive agent.
     *
     * \param[in]  agentNo            The number of the agent whose uncertainty offset is
     * to be modified. \param[in]  uncertaintyOffset  The replacement uncertainty offset.
     */
