                                ...
                                const World &world, Duration time_step)
{
    ...
    ////            }
    ////            path_point_list.emplace_back(intermediate_dest, 0,
    ///intermediate_orientation); /        }
    ...
    //                static_obstacles.insert(static_obstacles.end(),
    //                new_obstacles.begin(),
    //                                        new_obstacles.end());
    //            }
    //        }
    ...
    //
    //        auto path_point_opt =
    //            path.getCurrentPathPoint().value_or(PathPoint(Point(0, 0), 0,
    //            Angle::zero()));
    ...
    //                                   KinematicConstraints(max_speed, max_accel,
    //                                   max_decel), obstacles,
