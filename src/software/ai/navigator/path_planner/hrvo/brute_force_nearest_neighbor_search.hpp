 ...
 * @param neighbors a list of T objects neighbors, which may contain the candidate object itself
 * @param radius the maximum distance from a candidate object
 * @param comparator function that measures the square distance between a candidate and a neighbor
