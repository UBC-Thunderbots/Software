       ...
       test_both_defence_areas_blocked_starting_and_ending_in_blocked_areas)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::FRIENDLY_DEFENSE_AREA,TbotsProto::MotionConstraint::ENEMY_DEFENSE_AREA,
    ...
    test_both_defense_areas_and_centre_circle_blocked_starting_and_ending_in_blocked_areas)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::FRIENDLY_DEFENSE_AREA,TbotsProto::MotionConstraint::ENEMY_DEFENSE_AREA,
       TbotsProto::MotionConstraint::CENTER_CIRCLE,TbotsProto::MotionConstraint::AVOID_FIELD_BOUNDARY_ZONE};
    std::vector<ObstaclePtr> obstacles =
        obstacle_factory.createFromMotionConstraints(constraints, world.field());
       ...
       test_enemy_half_and_centre_circle_blocked_starting_in_blocked_area)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::ENEMY_HALF,TbotsProto::MotionConstraint::CENTER_CIRCLE,
...
TEST_F(TestGlobalPathPlanner, test_enemy_half_blocked_starting_and_ending_in_blocked_area)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::ENEMY_HALF,TbotsProto::MotionConstraint::FRIENDLY_DEFENSE_AREA,
       TbotsProto::MotionConstraint::AVOID_FIELD_BOUNDARY_ZONE};
    std::vector<ObstaclePtr> obstacles =
        obstacle_factory.createFromMotionConstraints(constraints, world.field());
...
TEST_F(TestGlobalPathPlanner, test_friendly_half_blocked_starting_in_blocked_area)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::FRIENDLY_HALF,TbotsProto::MotionConstraint::ENEMY_DEFENSE_AREA,
       TbotsProto::MotionConstraint::AVOID_FIELD_BOUNDARY_ZONE};
    std::vector<ObstaclePtr> obstacles =
        obstacle_factory.createFromMotionConstraints(constraints, world.field());
...
TEST_F(TestGlobalPathPlanner, test_leave_the_field)
{
    ...
    std::set<TbotsProto::MotionConstraint> constraints = {
       TbotsProto::MotionConstraint::ENEMY_DEFENSE_AREA,TbotsProto::MotionConstraint::FRIENDLY_DEFENSE_AREA};
    std::vector<ObstaclePtr> obstacles =
        obstacle_factory.createFromMotionConstraints(constraints, world.field());
