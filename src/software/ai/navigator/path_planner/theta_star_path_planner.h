...
class ThetaStarPathPlanner : public PathPlanner
{
   ...
   private:
     ...
     */
    std::optional<std::vector<ThetaStarPathPlanner::Coordinate>> lineOfSight(
        const Coordinate &coord0, const Coordinate &coord1);
     ...
     * @return true if line of sight from coord0 to coord1
     */
    std::optional<std::vector<ThetaStarPathPlanner::Coordinate>> checkLineLow(
        const Coordinate &coord0, const Coordinate &coord1);
     ...
     * @return true if line of sight from coord0 to coord1
     */
    std::optional<std::vector<ThetaStarPathPlanner::Coordinate>> checkLineHigh(
        const Coordinate &coord0, const Coordinate &coord1);
