                                                ...
                                                const Point &end) const
{
    ...
    {
        //        LOG(WARNING)
        //            << "Unable to find a path; Unable to find a nearby start and/or end
        //            point that isn't blocked "
        //            << "within the navigable area; no path found between " << start << "
        //            and "
        //            << end << std::endl;
        return std::nullopt;
    }
    ...
    if (path == std::nullopt)
    {
        //        LOG(WARNING) << "The path planner was unable to find a path between " <<
        //        start
        //                     << " and " << end << std::endl;
        return std::nullopt;
    }
