...
EnlsvgPathPlanner::EnlsvgPathPlanner(const Rectangle &navigable_area,
    ...
    : resolution(resolution),
      num_grid_rows(static_cast<unsigned int>(round(navigable_area.xLength() / resolution))),
      num_grid_cols(static_cast<unsigned int>(round(navigable_area.yLength() / resolution))),
