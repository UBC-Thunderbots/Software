 ...
 */
class OneTouchAttackerTactic : public Tactic
{
   public:
    /**
     * Creates a new OneTouchAttackerTactic
     *
     * @param ai_config The AI configuration
     */
    explicit OneTouchAttackerTactic(TbotsProto::AiConfig ai_config);

    OneTouchAttackerTactic() = delete;

    /**
     * Updates the control parameters for this OneTouchAttackerTactic.
     *
   ...
   private:
    ...
    std::map<RobotId, std::unique_ptr<FSM<OneTouchAttackerFSM>>> fsm_map;
