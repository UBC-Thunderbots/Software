...
class KickoffChipTactic : public Tactic
{
   public:
     ...
     */
    explicit KickoffChipTactic(const Ball& ball, bool loop_forever = false);

    std::string getName() const override;

    /**
     * Updates the world parameters for this KickoffChipTactic.
     *
    ...
    /**
     * Updates the control parameters for this KickoffChipTactic.
     *
