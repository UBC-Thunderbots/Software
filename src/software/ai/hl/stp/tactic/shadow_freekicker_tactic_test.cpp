...
TEST(ShadowFreekickerTacticTest, test_shadow_free_kicker_left_side_with_robot_in_enemy_team)
{
...
TEST(ShadowFreekickerTacticTest, test_shadow_free_kicker_right_side_with_robot_in_enemy_team)
{
    World world = ::Test::TestUtil::createBlankTestingWorld();
    world       = ::Test::TestUtil::setEnemyRobotPositions(
        world, {Point(0, world.field().friendlyCornerPos().y())},
