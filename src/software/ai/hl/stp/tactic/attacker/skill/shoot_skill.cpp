...
ShootSkill::ShootSkill(const TbotsProto::AiConfig& ai_config, std::shared_ptr<Strategy> strategy, double initial_score)
...
void ShootSkill::updatePrimitive(const Robot& robot, const World& world, const TacticUpdate& tactic_update)
{
    control_params.shot = strategy_->getBestShot(robot, world);
