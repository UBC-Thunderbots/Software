...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            Point(-3, 0.5),
            Angle.half(),
            BallState(Point(-3, 0.5), Vector(0, -0.1)),
        ...
        (
            ...
            Point(-3, 0.1),
            Angle.half(),
            BallState(Point(-3, 0.1), Vector(0, 0)),
            Duration.from_seconds(10),
        ),
        ...
        (
            ...
            Point(-3, -0.1),
            Angle.half(),
            BallState(Point(-3, -0.1), Vector(1, 2)),
            Duration.from_seconds(10),
        ),
    ],
)
def test_dribble_tactic(
    initial_position,
    dribble_destination,
    dribble_orientation,
    ball_state,
    ...
    eventually_validation_sequence_set = [
        ...
        lambda: robot_at_orientation(
            1, world_ptr, dribble_orientation, Angle.from_degrees(5), yield_func
        ),
        lambda: check_possession(tactic, world_ptr, yield_func),
    ]
