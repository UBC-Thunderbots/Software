...
TEST_F(DribbleTacticTest, test_close_proximity_slow_moving_ball)
{
    Point initial_position    = Point(-3, 0);
    Point dribble_destination = Point(-3, 0.5);
    Angle dribble_orientation = Angle::half();
    BallState ball_state(Point(-3, 0.5), Vector(0, -0.1));
    auto friendly_robots =
        TestUtil::createStationaryRobotStatesWithId({Point(-3, 2.5), initial_position});
...
TEST_F(DribbleTacticTest, test_close_proximity_stationary_ball)
{
    Point initial_position    = Point(-3, 0);
    Point dribble_destination = Point(-3, 0.1);
    Angle dribble_orientation = Angle::half();
    BallState ball_state(Point(-3, 0.1), Vector(0, 0));
    auto friendly_robots =
        TestUtil::createStationaryRobotStatesWithId({Point(-3, 2.5), initial_position});
...
TEST_F(DribbleTacticTest, test_close_proximity_fast_moving_ball)
{
    Point initial_position    = Point(-3, 0);
    Point dribble_destination = Point(-3, -0.1);
    Angle dribble_orientation = Angle::half();
    BallState ball_state(Point(-3, -0.1), Vector(1, 2));
    auto friendly_robots =
        TestUtil::createStationaryRobotStatesWithId({Point(-3, 2.5), initial_position});
