...
#     "blue_bots, yellow_bots, ball_initial_position",
#     [
#         (
#             tbots_cpp.Field.createSSLDivisionBField().friendlyDefenseArea().posXPosYCorner() + tbots_cpp.Vector(0.5, 0),
#             tbots_cpp.Point(1, 0),
#             tbots_cpp.Point(0, 0),
#         ),
#         (
#             tbots_cpp.Field.createSSLDivisionBField().friendlyDefenseArea().posXNegYCorner() + tbots_cpp.Vector(0.5, 0),
#             tbots_cpp.Point(1, 0),
#             tbots_cpp.Point(0, 0),
#         ),
#     ],
...
#                 enemy_threat_origin=tbots_cpp.createPointProto(ball_initial_position),
...
#                     tbots_cpp.Circle(ball_initial_position, 1)
#                 ]
#             ),
...
#                 regions=[
#                     tbots_cpp.Field.createSSLDivisionBField().friendlyDefenseArea().expand(0.25)
#                 ]
#             ),
#         ]
#     ]
...
friendlyDefenseAreaFrontCenter = tbots_cpp.Point(
    tbots_cpp.Field.createSSLDivisionBField().friendlyDefenseArea().posXPosYCorner().x(),
