...
class KickOrChipTacticTest
    : public SimulatedErForceSimPlayTestFixture,
      public ::testing::WithParamInterface<std::tuple<Vector, Angle, AutoChipOrKick>>
{
   protected:
...
TEST_P(KickOrChipTacticTest, kick_or_chip_test)
{
    ...
    auto tactic =
        std::make_shared<KickOrChipTactic>(std::make_shared<TbotsProto::AiConfig>());
