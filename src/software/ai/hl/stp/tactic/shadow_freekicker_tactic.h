...
class ShadowFreekickerTactic : public Tactic
{
   public:
     ...
     * slightly to the left of the vector from the enemy free_kicker to the friendly goal
     */
   ...
   private:
    ...
    const double FREE_KICK_MAX_PROXIMITY =
        0.50 * 1.05;  // Robots cannot be closer than 50cm from the ball during a free_kick
