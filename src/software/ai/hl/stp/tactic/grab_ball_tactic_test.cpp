...
TEST(GrabBallTacticTest, test_robot_intercepts_ball_if_no_enemies_near_ball)
{
    ...
    world = ::Test::TestUtil::setBallVelocity(world, Vector(0.5, 0), Timestamp::fromSeconds(0));
    ...
    GrabBallTactic tactic = GrabBallTactic(world.field(), world.ball(), world.enemyTeam(), true);
...
TEST(GrabBallTacticTest, test_robot_moves_to_the_ball_if_an_enemy_is_close_but_the_robot_is_far)
{
    World world = ::Test::TestUtil::createBlankTestingWorld();
    world = ::Test::TestUtil::setBallPosition(world, Point(0, 0), Timestamp::fromSeconds(0));
    world = ::Test::TestUtil::setBallVelocity(world, Vector(0, 0), Timestamp::fromSeconds(0));
    world = ::Test::TestUtil::setEnemyRobotPositions(world, {Point(0.2, 0)}, Timestamp::fromSeconds(0));
...
TEST(GrabBallTacticTest, test_robot_steals_the_ball_if_close_to_an_enemy_with_the_ball)
{
    ...
    world = ::Test::TestUtil::setBallPosition(world, Point(0, 0), Timestamp::fromSeconds(0));
    world = ::Test::TestUtil::setBallVelocity(world, Vector(0, 0), Timestamp::fromSeconds(0));
    world = ::Test::TestUtil::setEnemyRobotPositions(world, {Point(ROBOT_MAX_RADIUS_METERS, 0)}, Timestamp::fromSeconds(0));
    ...
    try
    {
        ...
        EXPECT_TRUE(movespin_intent.getDestination().isClose(world.ball().position(), 0.05));
    }
    catch (...)
    {
