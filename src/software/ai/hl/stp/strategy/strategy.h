...
class Strategy
{
   public:
    ...
    std::shared_ptr<StrategyImpl<EighteenZonePitchDivision, EighteenZoneId>> operator->();

   private:
    std::shared_ptr<StrategyImpl<EighteenZonePitchDivision, EighteenZoneId>> strategy_;
};
