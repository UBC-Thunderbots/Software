...
ShootOrChipPlay::ShootOrChipPlay(const TbotsProto::AiConfig& config, std::shared_ptr<Strategy> strategy)
...
static TGenericFactory<std::string, Play, ShootOrChipPlay, TbotsProto::AiConfig, std::shared_ptr<Strategy>> factory;
