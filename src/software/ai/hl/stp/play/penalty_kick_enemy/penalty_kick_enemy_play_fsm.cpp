...
PenaltyKickEnemyPlayFSM::PenaltyKickEnemyPlayFSM(std::shared_ptr<TbotsProto::AiConfig> ai_config_ptr)
    : PlayFSM<PenaltyKickEnemyPlayControlParams>(ai_config_ptr), move_tactics(std::vector<std::shared_ptr<MoveTactic>>())
{
}
