...
PassEndurancePlay::PassEndurancePlay(std::shared_ptr<TbotsProto::AiConfig> ai_config_ptr) : Play(ai_config_ptr, false) {}
...
static TGenericFactory<std::string, Play, PassEndurancePlay, std::shared_ptr<TbotsProto::AiConfig>>
    factory;
