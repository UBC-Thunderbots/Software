...
HaltTestPlay::HaltTestPlay(const TbotsProto::AiConfig& config, std::shared_ptr<Strategy> strategy)
...
static TGenericFactory<std::string, Play, HaltTestPlay, TbotsProto::AiConfig, std::shared_ptr<Strategy>> factory;
