...
//         ShootOrPassPlayFSM::ControlParams{},
//         PlayUpdate(
//             world, 4, [](PriorityTacticVector new_tactics) {},
...
//         ShootOrPassPlayFSM::ControlParams{},
//         PlayUpdate(
//             world, 2, [](PriorityTacticVector new_tactics) {},
//             InterPlayCommunication{},
//             [](InterPlayCommunication comm) {})));
...
//     // 3 process events needed so that fsm finds a pass between the 2 robots on the
//     field. fsm.process_event(ShootOrPassPlayFSM::Update(
//         ShootOrPassPlayFSM::ControlParams{},
//         PlayUpdate(
//             world, 2, [](PriorityTacticVector new_tactics) {},
//             InterPlayCommunication{},
...
//         ShootOrPassPlayFSM::ControlParams{},
//         PlayUpdate(
//             world, 3, [](PriorityTacticVector new_tactics) {},
//             InterPlayCommunication{},
//             [](InterPlayCommunication comm) {})));
...
//     // he takes the shot and triggers the tookShot guard, fsm goes into termination
//     state EXPECT_TRUE(fsm.is(boost::sml::state<boost::sml::back::terminate_state>));
// }
