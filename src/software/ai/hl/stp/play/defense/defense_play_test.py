    ...
    [
        (
            ...
            [
                ...
                tbots_cpp.Point(-3.8, -0.5),
                tbots_cpp.Point(1.0, 2.0),
                tbots_cpp.Point(1.0, -2.0),
            ],
        )
    ],
)
def test_defense_play_near_goal_line(simulated_test_runner, blue_bots, yellow_bots):
    def setup(*args):
        ball_initial_pos = tbots_cpp.Point(-3.8, 0.0)
