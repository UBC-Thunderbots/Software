...
void EnemyFreeKickPlayFSM::setTactics(const Update& event, unsigned int num_tactics)
{
     ...
     * 3) Skips additional pass defenders X meters around previously stated free kick pass
     * defender, this is set to a radius of 3m of the Main Pass Defender.
     *
     * NOTE: First pass defender is NOT SKIPPED, as I have elected to instead just skip
     * over all redundant pass defenders X meters around the main pass defender
     *
     * KNOWN BUGS:
