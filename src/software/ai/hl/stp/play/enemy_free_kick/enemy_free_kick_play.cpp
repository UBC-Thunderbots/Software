...
EnemyFreeKickPlay::EnemyFreeKickPlay(std::shared_ptr<TbotsProto::AiConfig> ai_config_ptr)
...
static TGenericFactory<std::string, Play, EnemyFreeKickPlay, std::shared_ptr<TbotsProto::AiConfig>>
    factory;
