...
AssignedTacticsPlay::AssignedTacticsPlay(std::shared_ptr<TbotsProto::AiConfig> ai_config_ptr)
...
static TGenericFactory<std::string, Play, AssignedTacticsPlay, std::shared_ptr<TbotsProto::AiConfig>>
    factory;
