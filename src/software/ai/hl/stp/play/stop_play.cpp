...
StopPlay::StopPlay(std::shared_ptr<TbotsProto::AiConfig> ai_config_ptr) : Play(ai_config_ptr, true) {}
...
static TGenericFactory<std::string, Play, StopPlay, std::shared_ptr<TbotsProto::AiConfig>> factory;
