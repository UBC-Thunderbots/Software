...
double ratePassWrapper(const std::string& ssl_wrapper_world_string,
                       py::dict pass_dict, bool receive_and_dribble)
{
    ...
    *sensor_proto.mutable_ssl_vision_msg() = wrapper_packet;
    ...
    PassType pass_type = receive_and_dribble ?
        PassType::RECEIVE_AND_DRIBBLE : PassType::ONE_TOUCH_SHOT;
