                ...
                const Point& ball_position, TbotsProto::PassingConfig passing_config)
{
    ...
    double enemy_risk_rating = zoneEnemyRiskRating(enemy_team, ball_position, zone,
                                                   passing_config);
