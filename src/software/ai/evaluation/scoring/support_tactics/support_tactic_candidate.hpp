...
class SupportTacticCandidate : public Candidate
{
   public:
     ...
     * type of support tactic this candidate represents
     */
    virtual std::shared_ptr<SupportTactic> createSupportTactic(
...
{
    static_assert(std::is_base_of<SupportTactic, TSupportTactic>::value,
                  "TSupportTactic must derive from SupportTactic");
   ...
   public:
    ...
    std::shared_ptr<SupportTactic> createSupportTactic(
