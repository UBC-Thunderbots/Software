...
class SuccessScorer : public SupportTacticScorer
{
   public:
     ...
     * 
     * @param score score between [-1, 1] rating the success of the tactics currently in use
     */
   ...
   private:
    // Maps types of tactics to a score rating the past performance and success of the tactic
