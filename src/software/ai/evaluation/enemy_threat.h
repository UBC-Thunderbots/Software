...
struct EnemyThreat
{
    ...
    // The number of enemy robots between the passer and receiver
    int num_robots_between_passer_and_receiver;
    ...
    bool operator==(const EnemyThreat &other) const
    {
        return this->robot == other.robot && this->has_ball == other.has_ball &&
               ...
               this->num_robots_between_passer_and_receiver ==
                   other.num_robots_between_passer_and_receiver;
    }
};
...
/**
 * Calculates how many enemy robots are positioned between the passer and receiver
 * along the line segment connecting them.
 *
 * @param passer The robot that would pass the ball
 * @param receiver The enemy robot that would receive the ball
 * @param enemy_team The enemy team containing all enemy robots
 * @return The number of enemy robots between the passer and receiver
 */
 ...
 * get threat score
 *
 * @param enemy enemy to get threat score of
