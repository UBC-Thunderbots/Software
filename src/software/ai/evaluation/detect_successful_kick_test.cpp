...
TEST(DetectSuccessfulKickTest, ball_over_speed_threshold_and_no_direction_difference_expect_success) {
...
TEST(DetectSuccessfulKickTest, ball_over_speed_threshold_and_small_negative_direction_difference) {
