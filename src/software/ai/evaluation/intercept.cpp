                                                                   ...
                                                                   const Robot &robot)
{
    ...
    static constexpr double BALL_MOVING_SLOW_SPEED_THRESHOLD   = 0.2;
...
std::optional<std::pair<Point, Duration>> findInterceptionPoint(const Robot &robot, const Ball &ball,
                                   const Field &field)
{
