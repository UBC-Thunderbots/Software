...
{
    Field field = ::Test::TestUtil::createSSLDivBField();
    Ball ball   = Ball(field.enemyGoalCenter(), Vector(0, 0), Timestamp::fromMilliseconds(0));
...
{
    Field field = ::Test::TestUtil::createSSLDivBField();
    Ball ball = Ball(field.friendlyGoalCenter(), Vector(0, 0), Timestamp::fromMilliseconds(0));
