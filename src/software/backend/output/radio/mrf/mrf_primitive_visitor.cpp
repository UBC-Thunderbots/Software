...
void MRFPrimitiveVisitor::visit(const ChipPrimitive &chip_primitive)
{
    ...
    radio_prim->add_parameter(chip_primitive.getChipDirection().toRadians() *
...
void MRFPrimitiveVisitor::visit(const DirectVelocityPrimitive &direct_velocity_primitive)
{
    ...
    radio_prim->add_parameter(direct_velocity_primitive.getXVelocity() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(direct_velocity_primitive.getYVelocity() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(direct_velocity_primitive.getAngularVelocity() *
                              CENTIRADIANS_PER_RADIAN);
...
void MRFPrimitiveVisitor::visit(const DribblePrimitive &dribble_primitive)
{
    ...
    radio_prim->add_parameter(dribble_primitive.getDestination().x() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(dribble_primitive.getDestination().y() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(dribble_primitive.getFinalAngle().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
...
void MRFPrimitiveVisitor::visit(const KickPrimitive &kick_primitive)
{
    ...
    radio_prim->add_parameter(kick_primitive.getKickDirection().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
...
void MRFPrimitiveVisitor::visit(const MovePrimitive &move_primitive)
{
    ...
    radio_prim->add_parameter(move_primitive.getDestination().x() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(move_primitive.getDestination().y() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(move_primitive.getFinalAngle().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
...
void MRFPrimitiveVisitor::visit(const MoveSpinPrimitive &movespin_primitive)
{
    ...
    radio_prim->add_parameter(movespin_primitive.getDestination().x() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(movespin_primitive.getDestination().y() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(movespin_primitive.getAngularVelocity().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
...
void MRFPrimitiveVisitor::visit(const PivotPrimitive &pivot_primitive)
{
    ...
    radio_prim->add_parameter(pivot_primitive.getPivotPoint().x() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(pivot_primitive.getPivotPoint().y() *
                              MILLIMETERS_PER_METER);
    radio_prim->add_parameter(pivot_primitive.getFinalAngle().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
    radio_prim->add_parameter(pivot_primitive.getPivotSpeed().toRadians() *
                              CENTIRADIANS_PER_RADIAN);
