...
void ProtobufPrimitiveVisitor::visit(const ChipPrimitive &chip_primitive)
{
    ...
    prim_msg->set_parameter1(chip_primitive.getChipOrigin().x() *
                               MILLIMETERS_PER_METER);
    prim_msg->set_parameter2(chip_primitive.getChipOrigin().y() *
                               MILLIMETERS_PER_METER);
...
void ProtobufPrimitiveVisitor::visit(const DirectVelocityPrimitive &direct_velocity_primitive)
{
    prim_msg = PrimitiveMsg();
...
void ProtobufPrimitiveVisitor::visit(const KickPrimitive &kick_primitive)
{
    prim_msg = PrimitiveMsg();
    prim_msg->set_prim_type(FirmwarePrimitiveType::SHOOT);
    prim_msg->set_parameter1(kick_primitive.getKickOrigin().x() *
                               MILLIMETERS_PER_METER);
    prim_msg->set_parameter2(kick_primitive.getKickOrigin().y() *
                               MILLIMETERS_PER_METER);
...
void ProtobufPrimitiveVisitor::visit(const MovePrimitive &move_primitive)
{
    ...
    prim_msg->set_parameter1(move_primitive.getDestination().x() *
                               MILLIMETERS_PER_METER);
    prim_msg->set_parameter2(move_primitive.getDestination().y() *
                               MILLIMETERS_PER_METER);
...
void ProtobufPrimitiveVisitor::visit(const MoveSpinPrimitive &movespin_primitive)
{
    ...
    prim_msg->set_parameter3(movespin_primitive.getAngularVelocity().toRadians() *
                               CENTIRADIANS_PER_RADIAN);
    prim_msg->set_parameter4(movespin_primitive.getFinalSpeed() *
                               MILLIMETERS_PER_METER);
    prim_msg->set_extra_bits(0);
}
...
void ProtobufPrimitiveVisitor::visit(const PivotPrimitive &pivot_primitive)
{
    ...
    prim_msg->set_parameter1(pivot_primitive.getPivotPoint().x() *
                               MILLIMETERS_PER_METER);
    prim_msg->set_parameter2(pivot_primitive.getPivotPoint().y() *
                               MILLIMETERS_PER_METER);
