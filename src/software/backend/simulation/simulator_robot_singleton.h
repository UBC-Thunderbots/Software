...
class SimulatorRobotSingleton
{
   public:
    ...
    /**
     * Starts a new primitive on the SimulatorRobot currently being controlled by this class
     *
     ...
     */
    static void startNewPrimitiveOnCurrentSimulatorRobot(std::shared_ptr<FirmwareWorld_t> firmware_world, unsigned int primitive_index, const primitive_params_t& primitive_params);

    /**
     * Runs the current primitive on the SimulatorRobot currently being controlled by this class
     *
     * @param firmware_world The world to run the primitive in
     */
    static void runPrimitiveOnCurrentSimulatorRobot(std::shared_ptr<FirmwareWorld_t> firmware_world);
