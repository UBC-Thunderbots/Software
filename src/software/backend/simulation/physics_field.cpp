...
void PhysicsField::setupFieldBoundary(std::shared_ptr<b2World> world, const Field &field)
{
    ...
    const unsigned int shape_loop_size = 4;
    b2Vec2 vs[shape_loop_size]         = {
    ...
    field_boundary_shape.CreateLoop(vs, shape_loop_size);
...
void PhysicsField::setupEnemyGoal(std::shared_ptr<b2World> world, const Field &field)
{
    ...
    const unsigned int shape_chain_size          = 4;
    b2Vec2 enemy_goal_vertices[shape_chain_size] = {
    ...
    enemy_goal_shape.CreateChain(enemy_goal_vertices, shape_chain_size);
...
void PhysicsField::setupFriendlyGoal(std::shared_ptr<b2World> world, const Field &field)
{
    ...
    const unsigned int shape_chain_size             = 4;
    b2Vec2 friendly_goal_vertices[shape_chain_size] = {
    ...
    friendly_goal_shape.CreateChain(friendly_goal_vertices, shape_chain_size);
