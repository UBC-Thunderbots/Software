...
ControllerInput::ControllerInput() : linear_motion_x(0.0), linear_motion_y(0.0), angular_motion(0.0), kick_button_pressed(false), chip_button_pressed(false), dribbler_button_pressed(false){}
