...
Xbox360Controller::Xbox360Controller(std::shared_ptr<const HandheldControllerInputConfig> controller_input_config) : Controller(controller_input_config) {}

ControllerInput Xbox360Controller::handleButtonEvent(ControllerInput controller_input, const unsigned int button_id, const bool is_button_pressed) {
    switch (button_id) {
        case 0: // The A button
...
ControllerInput Xbox360Controller::handleAxisEvent(ControllerInput controller_input, const unsigned int axis_id,
