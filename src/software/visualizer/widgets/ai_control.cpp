...
void setupAIControls(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
...
void setupAIStartAndStopButtons(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
    auto start_ai_func = [](std::shared_ptr<ThunderbotsConfig> config) {
        config->getMutableAIControlConfig()
            ->mutableRunAI()
            ->setValue(true);
    };
    QWidget::connect(widget->start_ai_button, &QPushButton::clicked, start_ai_func);
    auto stop_ai_func = [](std::shared_ptr<ThunderbotsConfig> config) {
        config->getMutableAIControlConfig()
            ->mutableRunAI()
            ->setValue(false);
    };
...
void setupTeamColourComboBox(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
...
void setupGameStateOverrideComboBox(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
...
void setupDefendingSideComboBox(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
    ...
    auto on_defending_side_changed = [config]() {
        if (text == "Use Refbox")
        {
            config->getMutableAIControlConfig()
                ->getMutableRefboxConfig()
...
void setupPlayOverrideComboBox(Ui::AutoGeneratedMainWidget *widget, std::shared_ptr<ThunderbotsConfig> config)
{
