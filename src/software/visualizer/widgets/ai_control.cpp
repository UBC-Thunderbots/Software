                                    ...
                                    std::shared_ptr<ThunderbotsConfig> config)
{
    ...
    auto on_gamestate_changed = [config](const QString &text) {
        auto refbox_config = config->getMutableAIControlConfig()->getMutableRefboxConfig();
        if (text == "Use Refbox")
        {
            refbox_config->mutableOverrideRefboxPlay()
                ->setValue(false);
        }
        else
        {
            refbox_config->mutableOverrideRefboxPlay()
                ->setValue(true);
            refbox_config->mutableCurrentRefboxPlay()
                                ...
                                std::shared_ptr<ThunderbotsConfig> config)
{
    ...
    auto on_defending_side_changed = [config](const QString &text) {
        ...
        if (text == "Use Refbox")
        {
            refbox_config->mutableOverrideRefboxDefendingSide()
                ->setValue(false);
        }
        else if (text == "East")
        {
            ...
            refbox_config->mutableDefendingPositiveSide()
                ->setValue(false);
        }
        else if (text == "West")
        {
