    ...
    const std::vector<RobotDetection> &new_robot_data)
{
    ...
    else
    {
        ...
        filtered_data.velocity = 
            (1-smoothing_factor) * current_robot_state.velocity() + smoothing_factor * filtered_data.velocity;
        ...
        filtered_data.angular_velocity = 
            (1-smoothing_factor) * current_robot_state.angularVelocity() + smoothing_factor * filtered_data.angular_velocity;
