...
class BallOcclusionTest: 
    ...
    public ::testing::WithParamInterface<std::tuple<BallState, std::vector<RobotStateWithId>, std::vector<RobotStateWithId>>>
{
...
INSTANTIATE_TEST_CASE_P(BallOcclusionTests, BallOcclusionTest, ::testing::Values(
    std::make_tuple(
        BallState(Point(-4.5, 3), Vector(1, 0)),
    ...
    std::make_tuple(
        BallState(Point(-4.5, -2), Vector(1, 0)),
        TestUtil::createStationaryRobotStatesWithId(
    ...
    std::make_tuple(
        BallState(Point(-4.5, 3), Vector(0, -1)),
        TestUtil::createStationaryRobotStatesWithId(
    ...
    std::make_tuple(
        BallState(Point(-3, 0), Vector(-1, 0)),
        TestUtil::createStationaryRobotStatesWithId({Point(-4.5, 0)}),
        TestUtil::createStationaryRobotStatesWithId({Point(-2.8, 0)})
    ),
    std::make_tuple(
        BallState(Point(3, 0), Vector(0, 1)),
        TestUtil::createStationaryRobotStatesWithId({Point(2.8, 0)}),
        TestUtil::createStationaryRobotStatesWithId({Point(4.5, 0)})
    ),
    std::make_tuple(
        BallState(Point(-3.5, -1), Vector(-1, 1)),
        TestUtil::createStationaryRobotStatesWithId({Point(-4.5, 0)}),
        TestUtil::createStationaryRobotStatesWithId(
    ...
    std::make_tuple(
        BallState(Point(-4.5 + 0.2 / sqrt(2.0), 3 - 0.2 / sqrt(2.0)),
    ...
    std::make_tuple(
        BallState(Point(-4, -3), Vector(1, 3)),
        TestUtil::createStationaryRobotStatesWithId(
    ...
    std::make_tuple(
        BallState(Point(-4, -3), Vector(4, 1)),
        TestUtil::createStationaryRobotStatesWithId({
