...
int main(int argc, char **argv)
{
    ...
    if (!args.help && !args.err)
    {
        ...
        std::shared_ptr<const AIConfig> ai_config = Util::DynamicParameters->getAIConfig();
        std::shared_ptr<const AIControlConfig> ai_control_config = Util::DynamicParameters->getAIControlConfig();
