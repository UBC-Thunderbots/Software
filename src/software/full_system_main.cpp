...
int main(int argc, char** argv)
{
    ...
    if (!help_requested)
    {
        ...
        mutable_thunderbots_config->getMutableSensorFusionConfig()->getMutableFriendlyColorYellow()->setValue(args->getTeamColor()->value() == "yellow");
        mutable_thunderbots_config->getMutableSensorFusionConfig()->getMutableOverrideGameControllerDefendingSide()->setValue(args->getDefendingSide()->value() != "gamecontroller");
        mutable_thunderbots_config->getMutableSensorFusionConfig()->getMutableDefendingPositiveSide()->setValue(args->getDefendingSide()->value() == "positive");
        mutable_thunderbots_config->getMutableNetworkConfig()->getMutableChannel()->setValue(args->getChannel()->value());
