...
// SPI Chip Selects
static const uint8_t FRONT_LEFT_MOTOR_CHIP_SELECT =
    motor_service_->FRONT_LEFT_MOTOR_CHIP_SELECT;
static const uint8_t FRONT_RIGHT_MOTOR_CHIP_SELECT =
    motor_service_->FRONT_RIGHT_MOTOR_CHIP_SELECT;
static const uint8_t BACK_LEFT_MOTOR_CHIP_SELECT =
    motor_service_->BACK_LEFT_MOTOR_CHIP_SELECT;
static const uint8_t BACK_RIGHT_MOTOR_CHIP_SELECT =
    motor_service_->BACK_RIGHT_MOTOR_CHIP_SELECT;

static const uint8_t CHIP_SELECT[] = {
    FRONT_LEFT_MOTOR_CHIP_SELECT, FRONT_RIGHT_MOTOR_CHIP_SELECT,
    BACK_LEFT_MOTOR_CHIP_SELECT, BACK_RIGHT_MOTOR_CHIP_SELECT};
