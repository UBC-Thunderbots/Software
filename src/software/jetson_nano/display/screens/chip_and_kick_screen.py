...
class ChipAndKickScreen(Screen):
    def __init__(self, lcd_display, key_list):
        ...
        def draw_screen():
            ...
            self.lcd_display.draw.text((x, y), set_chip_and_kick_str, font=self.font, fill="#ffffff")
            ...
            self.lcd_display.draw.text((x, y), str(round(self.speeds[CHIP], 1)), font=self.font, fill="#00ffff")
            ...
            self.lcd_display.draw.text((x, y), str(round(self.speeds[KICK], 1)), font=self.font, fill="#00ffff")
