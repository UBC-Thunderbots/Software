                ...
                double matrix_x_vel, double matrix_y_vel, double matrix_angular_vel)
{
    ...
    QWidget::connect(widget->pushButton_per_motor_execute, &QPushButton::clicked, per_motor_execute_pushed);
    QWidget::connect(widget->pushButton_matrix_execute, &QPushButton::clicked, matrix_execute_pushed);
}
