...
def test_one_robots_square(field_test_runner):
    ...
    point1 = Point(x_meters=0.8, y_meters=-0.0)
    point2 = Point(x_meters=-0.9, y_meters=-0.0)
    point3 = Point(x_meters=-0.9, y_meters=-0.6)
    point4 = Point(x_meters=0.8, y_meters=-0.6)
