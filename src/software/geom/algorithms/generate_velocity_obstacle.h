 ...
 */
VelocityObstacle generateVelocityObstacle(const Circle& obstacle, const Circle &robot, const Vector& obstacle_velocity);
VelocityObstacle generateVelocityObstacle(const Polygon &obstacle, const Circle &robot, const Vector& obstacle_velocity);
