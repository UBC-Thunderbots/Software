 ...
 * A convex angle is between 0 and 180 degrees inclusive-
 * https://proofwiki.org/wiki/Definition:Convex_Angle
 *
 * @param v1
 * @param v2
 *
 * @return The convex angle formed by v1 and v2, in the range [0, 180]
 */
 ...
 * @param p3
 *
 * @return The convex angle formed by the vector p2->p1 and p2->p3, in the range [0, 180]
 */
