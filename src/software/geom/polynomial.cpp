...
Polynomial::Polynomial(const std::vector<double>& coeffs) : coeffs(coeffs)
{
    ...
    {
        throw std::invalid_argument("Size of coeffs vector isn't the order of the polynomial");
    }
}
                       ...
                       const std::pair<double, double>& constraint2)
{
    ...
    double slope = (constraint2.second - constraint1.second) / (constraint2.first - constraint1.first);
