...
class RefereeStageTest
    : public ::testing::TestWithParam<std::tuple<RefereeStage, SSL::SSL_Referee_Stage>>
{
};
...
TEST_P(RefereeStageTest, test_referee_stage)
{
    ...
    SSL::SSL_Referee_Stage input = std::get<1>(GetParam());
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple(RefereeStage::NORMAL_FIRST_HALF_PRE,
                                      SSL::SSL_Referee_Stage_NORMAL_FIRST_HALF_PRE),
                      std::make_tuple(RefereeStage::NORMAL_FIRST_HALF,
                                      SSL::SSL_Referee_Stage_NORMAL_FIRST_HALF),
                      std::make_tuple(RefereeStage::NORMAL_HALF_TIME,
                                      SSL::SSL_Referee_Stage_NORMAL_HALF_TIME),
                      ...
                      std::make_tuple(RefereeStage::NORMAL_SECOND_HALF,
                                      SSL::SSL_Referee_Stage_NORMAL_SECOND_HALF),
                      std::make_tuple(RefereeStage::EXTRA_TIME_BREAK,
                                      SSL::SSL_Referee_Stage_EXTRA_TIME_BREAK),
                      std::make_tuple(RefereeStage::EXTRA_FIRST_HALF_PRE,
                                      SSL::SSL_Referee_Stage_EXTRA_FIRST_HALF_PRE),
                      std::make_tuple(RefereeStage::EXTRA_FIRST_HALF,
                                      SSL::SSL_Referee_Stage_EXTRA_FIRST_HALF),
                      std::make_tuple(RefereeStage::EXTRA_HALF_TIME,
                                      SSL::SSL_Referee_Stage_EXTRA_HALF_TIME),
                      std::make_tuple(RefereeStage::EXTRA_SECOND_HALF_PRE,
                                      SSL::SSL_Referee_Stage_EXTRA_SECOND_HALF_PRE),
                      std::make_tuple(RefereeStage::EXTRA_SECOND_HALF,
                                      SSL::SSL_Referee_Stage_EXTRA_SECOND_HALF),
                      ...
                      std::make_tuple(RefereeStage::PENALTY_SHOOTOUT,
                                      SSL::SSL_Referee_Stage_PENALTY_SHOOTOUT),
                      std::make_tuple(RefereeStage::POST_GAME,
                                      SSL::SSL_Referee_Stage_POST_GAME)));

class RefereeCommandTest
    : public ::testing::TestWithParam<
          std::tuple<RefereeCommand, SSL::SSL_Referee_Command, TeamColour>>
{
};
...
TEST_P(RefereeCommandTest, test_referee_command)
{
    ...
    SSL::SSL_Referee_Command input = std::get<1>(GetParam());
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        std::make_tuple(RefereeCommand::HALT, SSL::SSL_Referee_Command_HALT,
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::STOP, SSL::SSL_Referee_Command_STOP,
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::NORMAL_START,
                        SSL::SSL_Referee_Command_NORMAL_START, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::FORCE_START, SSL::SSL_Referee_Command_FORCE_START,
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::HALT, SSL::SSL_Referee_Command_HALT,
                        TeamColour::BLUE),
        std::make_tuple(RefereeCommand::STOP, SSL::SSL_Referee_Command_STOP,
                        TeamColour::BLUE),
        std::make_tuple(RefereeCommand::NORMAL_START,
                        SSL::SSL_Referee_Command_NORMAL_START, TeamColour::BLUE),
        std::make_tuple(RefereeCommand::FORCE_START, SSL::SSL_Referee_Command_FORCE_START,
                        TeamColour::BLUE),
        ...
        std::make_tuple(RefereeCommand::PREPARE_KICKOFF_US,
                        ...
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::PREPARE_KICKOFF_US,
                        SSL::SSL_Referee_Command_PREPARE_KICKOFF_BLUE, TeamColour::BLUE),
        ...
        std::make_tuple(RefereeCommand::PREPARE_PENALTY_US,
                        ...
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::PREPARE_PENALTY_US,
                        SSL::SSL_Referee_Command_PREPARE_PENALTY_BLUE, TeamColour::BLUE),
        ...
        std::make_tuple(RefereeCommand::DIRECT_FREE_US,
                        SSL::SSL_Referee_Command_DIRECT_FREE_YELLOW, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::DIRECT_FREE_US,
                        SSL::SSL_Referee_Command_DIRECT_FREE_BLUE, TeamColour::BLUE),
        std::make_tuple(RefereeCommand::DIRECT_FREE_THEM,
                        SSL::SSL_Referee_Command_DIRECT_FREE_BLUE, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::DIRECT_FREE_THEM,
                        SSL::SSL_Referee_Command_DIRECT_FREE_YELLOW, TeamColour::BLUE),
        ...
        std::make_tuple(RefereeCommand::INDIRECT_FREE_US,
                        ...
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::INDIRECT_FREE_US,
                        SSL::SSL_Referee_Command_INDIRECT_FREE_BLUE, TeamColour::BLUE),
        std::make_tuple(RefereeCommand::INDIRECT_FREE_THEM,
                        SSL::SSL_Referee_Command_INDIRECT_FREE_BLUE, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::INDIRECT_FREE_THEM,
                        SSL::SSL_Referee_Command_INDIRECT_FREE_YELLOW, TeamColour::BLUE),

        // timeout
        std::make_tuple(RefereeCommand::TIMEOUT_US,
                        SSL::SSL_Referee_Command_TIMEOUT_YELLOW, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::TIMEOUT_US, SSL::SSL_Referee_Command_TIMEOUT_BLUE,
                        TeamColour::BLUE),
        std::make_tuple(RefereeCommand::TIMEOUT_THEM,
                        SSL::SSL_Referee_Command_TIMEOUT_BLUE, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::TIMEOUT_THEM,
                        SSL::SSL_Referee_Command_TIMEOUT_YELLOW, TeamColour::BLUE),

        // goal
        std::make_tuple(RefereeCommand::GOAL_US, SSL::SSL_Referee_Command_GOAL_YELLOW,
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::GOAL_US, SSL::SSL_Referee_Command_GOAL_BLUE,
                        TeamColour::BLUE),
        std::make_tuple(RefereeCommand::GOAL_THEM, SSL::SSL_Referee_Command_GOAL_BLUE,
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::GOAL_THEM, SSL::SSL_Referee_Command_GOAL_YELLOW,
                        TeamColour::BLUE),
        ...
        std::make_tuple(RefereeCommand::BALL_PLACEMENT_US,
                        ...
                        TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::BALL_PLACEMENT_US,
                        SSL::SSL_Referee_Command_BALL_PLACEMENT_BLUE, TeamColour::BLUE),
        std::make_tuple(RefereeCommand::BALL_PLACEMENT_THEM,
                        SSL::SSL_Referee_Command_BALL_PLACEMENT_BLUE, TeamColour::YELLOW),
        std::make_tuple(RefereeCommand::BALL_PLACEMENT_THEM,
                        SSL::SSL_Referee_Command_BALL_PLACEMENT_YELLOW,
                        TeamColour::BLUE)));
...
{
    SSL::SSL_Referee ref;
    auto ref_point = std::make_unique<SSL::SSL_Referee_Point>();
