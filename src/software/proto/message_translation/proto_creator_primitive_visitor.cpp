...
{
    PrimitiveParamsMsg params;
    params.set_parameter1(static_cast<float>(catch_primitive.getVelocity()));
    params.set_parameter2(static_cast<float>(catch_primitive.getDribblerSpeed()));
    params.set_parameter3(static_cast<float>(catch_primitive.getMargin()));
