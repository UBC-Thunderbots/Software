...
std::unique_ptr<DefendingSideProto> createDefendingSide(const FieldSide& defending_side)
{
    ...
    switch(defending_side) {
        case FieldSide::NEG_X:
            msg->set_defending_side(DefendingSideProto::FieldSide::DefendingSideProto_FieldSide_NEG_X);
            break;
        case FieldSide::POS_X:
            msg->set_defending_side(DefendingSideProto::FieldSide::DefendingSideProto_FieldSide_POS_X);
            break;
    }
