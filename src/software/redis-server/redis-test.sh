...
g++ -std=c++17 -o ./cpp/cpp_redis ./cpp/cpp_redis.cpp ./cpp/redis-plus-plus/build/libredis++.a ./cpp/hiredis/libhiredis.a -pthread
...
python3 python/python_redis.py set $SET_KEY1 $SET_VALUE1 
echo "GET $SET_KEY1"
python3 python/python_redis.py get $SET_KEY1 
...
./cpp/cpp_redis set $SET_KEY2 $SET_VALUE2
echo "GET $SET_KEY2"
./cpp/cpp_redis get $SET_KEY2
...
python3 python/python_redis.py set $SET_KEY3 $SET_VALUE3
echo "GET $SET_KEY3"
./cpp/cpp_redis get $SET_KEY3
...
./cpp/cpp_redis set $SET_KEY4 $SET_VALUE4
echo "GET $SET_KEY4"
python3 python/python_redis.py get $SET_KEY4
