                     ...
                     std::shared_ptr<ThunderbotsConfig> config)
{
    ...
    setupGoalieIDComboBox(
        widget->friendly_goalie_id_combo_box, config->getMutableSensorFusionConfig()->mutableOverrideGameControllerFriendlyGoalieID(),
        config->getMutableSensorFusionConfig()->mutableFriendlyGoalieId());
    setupGoalieIDComboBox(
            widget->enemy_goalie_id_combo_box, config->getMutableSensorFusionConfig()->mutableOverrideGameControllerEnemyGoalieID(),
