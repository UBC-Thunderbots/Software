...
{
    setupGoalieIDComboBox(widget->friendly_goalie_id_combo_box, override_friendly_goalie_id_parameter, friendly_goalie_id_parameter);
}
...
{
    setupGoalieIDComboBox(widget->enemy_goalie_id_combo_box, override_enemy_goalie_id_parameter, enemy_goalie_id_parameter);
}
        ...
        std::shared_ptr<Parameter<int>> goalie_id_parameter)
{
    ...
    auto on_goalie_id_changed =
            [override_goalie_id_parameter,
                    goalie_id_parameter, robot_ids](const QString &text) {
        if (text == "Use GameController")
        {
    ...
    QWidget::connect(id_comboBox, &QComboBox::currentTextChanged,
