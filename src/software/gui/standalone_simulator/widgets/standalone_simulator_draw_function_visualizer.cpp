...
StandaloneSimulatorDrawFunctionVisualizer::StandaloneSimulatorDrawFunctionVisualizer(QWidget* parent) : DrawFunctionVisualizer(parent) {

}

void StandaloneSimulatorDrawFunctionVisualizer::registerBallPlacementCallback(const std::function<void (Point)> &callback) {
