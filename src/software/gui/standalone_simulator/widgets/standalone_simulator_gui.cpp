...
StandaloneSimulatorGUI::StandaloneSimulatorGUI(std::shared_ptr<StandaloneSimulator> simulator)
    : QMainWindow(),
...
{
    if(!simulator) {
        throw std::invalid_argument("Cannot create StandaloneSimulatorGUI without a valid StandaloneSimulator");
    }
