...
void RobotStatusTable::updateTbotsRobotStatusMsg(
    const TbotsRobotStatusMsg& tbots_robot_status_msg)
{
    for (const auto& error_code : tbots_robot_status_msg.error_code())
    {
        std::string message =
