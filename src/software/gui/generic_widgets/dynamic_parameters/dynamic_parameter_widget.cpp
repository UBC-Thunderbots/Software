...
DynamicParameterWidget::DynamicParameterWidget(QWidget* parent) : QWidget(parent){
    QVBoxLayout* widget_layout     = new QVBoxLayout(this);

    QScrollArea* scroll_area = new QScrollArea(this);
    QVBoxLayout* scroll_area_layout     = new QVBoxLayout(scroll_area);

    setupParametersHelper(this, scroll_area_layout, MutableDynamicParameters);
                              ...
                              QVBoxLayout* layout, MutableParameterVariant param_var)
{
    std::visit(overload{[&](std::shared_ptr<Parameter<int>> param) {
                        ...
                        [&](std::shared_ptr<Config> param) {
                            ...
                            {
                                setupParametersHelper(params_widget, layout, v);
                            }
                        }},
               param_var);
}
