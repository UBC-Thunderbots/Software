...
void PlayInfoWidget::updatePlayInfo(const PlayInfoProto& play_info)
{
    QString referee_command_string =
        QString("Referee Command: %1\n")
            .arg(QString::fromStdString(play_info.referee_command_name()));
    ...
    {
        tactics_string.append(QString::fromStdString(tactic_string.first)).append(", ")
        .append(QString::fromStdString(tactic_string.second)).append("\n");
    }
