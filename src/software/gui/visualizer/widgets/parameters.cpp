...
void setupParametersTabHelper(Ui::AutoGeneratedMainWidget* widget,
                              ParameterVariant param_var)
{
    std::visit(overload{[&](std::shared_ptr<const Parameter<int>> param) {
                        ...
                        [&](std::shared_ptr<const Config> param) {
                            ...
                            {
                                setupParametersTabHelper(widget, v);
                            }
                        }},
               param_var);
}
...
void setupParametersTab(Ui::AutoGeneratedMainWidget* widget)
{
    ...
    setupParametersTabHelper(widget, DynamicParameters);
