   ...
   public:
    FieldTest()
        : x_length(9.0),
          ...
          field(x_length, y_length, defense_x_length, defense_y_length, goal_x_length, goal_y_length,
...
{
    Field field_1 = Field(x_length, y_length, defense_x_length, defense_y_length, goal_x_length,
                          goal_y_length, boundary_buffer_size, center_circle_radius);

    Field field_2 = Field(x_length / 2, y_length, defense_x_length, defense_y_length, goal_x_length,
                          goal_y_length, boundary_buffer_size, center_circle_radius);
...
TEST_F(FieldTest, equality_operator_fields_with_different_y_lengths)
{
    ...
    Field field_2 = Field(x_length, y_length * 2, defense_x_length, defense_y_length, goal_x_length,
                          goal_y_length, boundary_buffer_size, center_circle_radius);
...
TEST_F(FieldTest, equality_operator_fields_with_different_defense_x_length)
{
    ...
    Field field_2 = Field(x_length, y_length, defense_x_length * 2, defense_y_length, goal_x_length,
                          goal_y_length, boundary_buffer_size, center_circle_radius);
...
TEST_F(FieldTest, equality_operator_fields_with_different_defense_y_length)
{
    ...
    Field field_2 = Field(x_length, y_length, defense_x_length, defense_y_length / 2, goal_x_length,
                          goal_y_length, boundary_buffer_size, center_circle_radius);
...
TEST_F(FieldTest, equality_operator_fields_with_different_goal_x_length)
{
    ...
    Field field_2 = Field(x_length, y_length, defense_x_length, defense_y_length, goal_x_length + 0.2,
                          goal_y_length, boundary_buffer_size, center_circle_radius);
...
TEST_F(FieldTest, equality_operator_fields_with_different_goal_y_length)
{
    ...
    Field field_2 = Field(x_length, y_length, defense_x_length, defense_y_length, goal_x_length,
