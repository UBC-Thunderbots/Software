...
TEST(LinearBallModelTest, test_rolling_friction)
{
    Point position(3, 5);
    Vector velocity(3, -2);
    LinearBallModel model(BallState(position, velocity), 1.3, 2.2, 10);
...
TEST(LinearBallModelTest, test_sliding_friction)
{
    Point position(3, 5);
    Vector velocity(3, -2);
    LinearBallModel model(BallState(position, velocity), 1.3, 2.2, 1);
...
TEST(LinearBallModelTest, test_invalid_args)
{
    Point position(3, 5);
    Vector velocity(3, -2);
    EXPECT_THROW(LinearBallModel(BallState(position, velocity), -1.3, 2.2, 1),
