...
{
    RobotStateWithTimestamp state(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
...
{
    RobotStateWithTimestamp state(RobotState(Point(1.1, -0.5), Vector(3, 0),
...
{
    RobotStateWithTimestamp state_1(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    RobotStateWithTimestamp state_2(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
...
{
    RobotStateWithTimestamp state_1(Point(1.1, -0.6), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    RobotStateWithTimestamp state_2(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    EXPECT_FALSE(state_1 == state_2);
...
{
    RobotStateWithTimestamp state_1(Point(1.1, -0.5), Vector(3, 1.2), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    RobotStateWithTimestamp state_2(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    EXPECT_FALSE(state_1 == state_2);
...
{
    RobotStateWithTimestamp state_1(Point(1.1, -0.5), Vector(3, 0), Angle::half(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    RobotStateWithTimestamp state_2(Point(1.1, -0.5), Vector(3, 0), Angle::quarter(),
                                    AngularVelocity::half(), Timestamp::fromSeconds(0.1));
    EXPECT_FALSE(state_1 == state_2);
