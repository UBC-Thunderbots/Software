...
{
    BallStateWithTimestamp ball_state_1(BallState(Point(1, -2.3), Vector(0, 0.4)),
                                        Timestamp::fromSeconds(0));
    BallStateWithTimestamp ball_state_2(Point(1, -2.3), Vector(0, 0.4),
                                        Timestamp::fromSeconds(0));
...
{
    BallStateWithTimestamp ball_state_1(Point(1, -2.3), Vector(0, 0.4),
                                        Timestamp::fromSeconds(0));
    BallStateWithTimestamp ball_state_2(Point(1, -2.4), Vector(0, 0.4),
                                        Timestamp::fromSeconds(0));
    EXPECT_FALSE(ball_state_1 == ball_state_2);
    EXPECT_TRUE(ball_state_1 != ball_state_2);
}
...
TEST(BallStateWithTimestampTest, compare_states_with_different_velocities)
{
    BallStateWithTimestamp ball_state_1(Point(1, -2.3), Vector(0, 0.4),
                                        Timestamp::fromSeconds(0));
    BallStateWithTimestamp ball_state_2(Point(1, -2.3), Vector(-1, 0.4),
                                        Timestamp::fromSeconds(0));
    EXPECT_FALSE(ball_state_1 == ball_state_2);
    EXPECT_TRUE(ball_state_1 != ball_state_2);
}
