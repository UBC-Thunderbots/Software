macro(generate_cfgs_from_yaml)
    ...
    execute_process(
        COMMAND python3 ${CMAKE_CURRENT_SOURCE_DIR}/parameter/generate_parameters.py
        WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        )

    # Store autogenerated cfgs
    file(GLOB_RECURSE AUTOGENERATED_CFGS LIST_DIRECTORIES false CONFIGURE_DEPENDS
        ${CMAKE_CURRENT_SOURCE_DIR}/parameter/autogenerated/cfg/*.cfg
        )
    ...
    set_property(
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/parameter/config
        )
