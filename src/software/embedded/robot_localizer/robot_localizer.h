...
static constexpr VISION_X_INITIAL_VARIANCE_M = 0.00001;
static constexpr VISION_Y_INITIAL_VARIANCE_M = 0.00001;
static constexpr VISION_THETA_INITIAL_VARIANCE_RAD = 0.00001;
static constexpr MOTOR_THETA_INITIAL_VARIANCE_M_S = 0.5;
static constexpr MOTOR_THETA_INITIAL_VARIANCE_M_S = 0.5;
static constexpr MOTOR_THETA_INITIAL_VARIANCE_M_S = 0.5;

static constexpr PROCESS_MODEL_INITIAL_VARIANCE = 0.5;
/**
