...
TEST(LinearSpline2dTest, test_constructor_three_knot)
{
    ...
    EXPECT_TRUE(
        equalWithinTolerance(s.getValueAt(0.1), Point(3.8, 14.4), 1e-9));
...
TEST(LinearSpline2dTest, test_constructor_two_knot)
{
    ...
    EXPECT_EQ(s.getValueAt(0.0), points[0]);
    EXPECT_TRUE(
        equalWithinTolerance(s.getValueAt(0.1), Point(-2.3, -15.7), 1e-9));
    EXPECT_TRUE(equalWithinTolerance(s.getValueAt(0.5), Point(0.5, 5.5), 1e-9));
    EXPECT_TRUE(
        equalWithinTolerance(s.getValueAt(0.6), Point(1.2, 10.8), 1e-7));
    EXPECT_TRUE(
        equalWithinTolerance(s.getValueAt(0.9), Point(3.3, 26.7), 1e-7));
