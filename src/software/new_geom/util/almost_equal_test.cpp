...
TEST(AlmostEqualTest, ten_ulps_greater_than_zero)
{
    ...
    EXPECT_TRUE(almostEqual(a, b, GeomConstants::FIXED_EPSILON, 5));
}
...
TEST(AlmostEqualTest, twenty_ulps_greater_than_one)
{
    ...
    EXPECT_TRUE(almostEqual(a, b, GeomConstants::FIXED_EPSILON, 20));
    EXPECT_FALSE(almostEqual(a, b, GeomConstants::FIXED_EPSILON, 19));
}
