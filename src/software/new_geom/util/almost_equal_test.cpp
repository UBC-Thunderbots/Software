...
{
    double a = 1.0;
    double b = 1.0 - 2e-15; // For comparing doubles near 1.0, 2e-15 is too big to consider equal
...
{
    double a = 1.0;
    double b = 10.0 - 2e-14; // For comparing doubles near 1.0, 2e-14 is too big to consider equal
    EXPECT_FALSE(almostEqual(a, b));
}