...
THUNDERSCOPE_HELP_TEXT = textwrap.dedent(
    ...
    <b><code>Shift+Double Click</code></b> Push the current obstacle to the obstacle stack. GLDrawPolygonObstalce layer must be enabled.<br><br>
    <b><code>c</code></b> Clear the virtual obstacle stack GLDrawPolygonObstalce layer must be enabled. <br><br>
