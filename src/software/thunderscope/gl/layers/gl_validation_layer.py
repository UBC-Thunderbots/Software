...
class GLValidationLayer(GLLayer):
    ...
    def __init__(
        ...
        self.validation_set_buffer = ThreadSafeBuffer(
            buffer_size, protos.ValidationProtoSet
        )
    ...
    def __update_validation_graphics(
        self, validations: list[protos.ValidationProto]
    ) -> None:
