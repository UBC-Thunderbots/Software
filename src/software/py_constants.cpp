...
PYBIND11_MODULE(py_constants, m)
{
    ...
    // YAML related constants
    m.attr("ROBOT_PATH_TO_YAML_CONFIG") = ROBOT_PATH_TO_YAML_CONFIG;
    m.attr("ROBOT_ID_YAML_KEY") = ROBOT_ID_YAML_KEY;
    m.attr("ROBOT_MULTICAST_CHANNEL_YAML_KEY") = ROBOT_MULTICAST_CHANNEL_YAML_KEY;
    m.attr("ROBOT_NETWORK_INTERFACE_YAML_KEY") = ROBOT_NETWORK_INTERFACE_YAML_KEY;
    m.attr("ROBOT_KICK_CONSTANT_YAML_KEY") = ROBOT_KICK_CONSTANT_YAML_KEY;
    m.attr("ROBOT_KICK_EXP_COEFF_YAML_KEY") = ROBOT_KICK_EXP_COEFF_YAML_KEY;
    m.attr("ROBOT_CHIP_PULSE_WIDTH_YAML_KEY") = ROBOT_CHIP_PULSE_WIDTH_YAML_KEY;
