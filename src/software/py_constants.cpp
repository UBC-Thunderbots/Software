...
PYBIND11_MODULE(py_constants, m)
{
    ...
    m.attr("ROBOT_TO_FULL_SYSTEM_IP_NOTIFICATION_PORT") = ROBOT_TO_FULL_SYSTEM_IP_NOTIFICATION_PORT;
    m.attr("FULL_SYSTEM_TO_ROBOT_IP_NOTIFICATION_PORT") = FULL_SYSTEM_TO_ROBOT_IP_NOTIFICATION_PORT;
