...
PYBIND11_MODULE(py_constants, m)
{
    ...
    m.attr("ROBOT_STATISTIC_PATH")      = ROBOT_STATISTIC_PATH;
    ...
    m.attr("ROBOT_IP_NOTIFICATION_PORT") = ROBOT_IP_NOTIFICATION_PORT;
    m.attr("FULLSYSTEM_IP_NOTIFICATION_PORT") = FULLSYSTEM_IP_NOTIFICATION_PORT;
