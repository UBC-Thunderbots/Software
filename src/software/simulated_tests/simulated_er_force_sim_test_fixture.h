...
class SimulatedErForceSimTestFixture : public ::testing::Test
{
   ...
   private:
     ...
     * @param robots_displacement the array that saves the displacement of each robot in id order 
     * @param robots_velocity_diff the array that saves the velocity difference of each robot in id order 
