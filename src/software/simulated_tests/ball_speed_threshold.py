...
class BallSpeedThreshold(Validation):
    ...
    def get_validation_geometry(self, world) -> ValidationGeometry:
        ...
        ball_x = (
            world.ball.current_state.global_position.x_meters * MILLIMETERS_PER_METER
        )
        ball_y = (
            world.ball.current_state.global_position.y_meters * MILLIMETERS_PER_METER
        )
        ...
        validation_centre_x = (
            ball_x + MILLIMETERS_PER_METER * self.speed_threshold * math.cos(ball_angle)
        )
        validation_centre_y = (
            ball_y + MILLIMETERS_PER_METER * self.speed_threshold * math.sin(ball_angle)
        )
    ...
    def get_validation_line_endpoints(
        self, validation_centre_x, validation_centre_y, ball_angle
    ):
        start_x = (
            validation_centre_x
