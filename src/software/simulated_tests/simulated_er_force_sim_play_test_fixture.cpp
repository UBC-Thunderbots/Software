...
SimulatedErForceSimPlayTestFixture::SimulatedErForceSimPlayTestFixture()
    : game_state(), ai(std::make_shared<TbotsProto::AiConfig>(friendly_thunderbots_config.ai_config()))
{
}
    ...
    const TbotsProto::PlayName& ai_play_name)
{
    ...
    ai = Ai(std::make_shared<TbotsProto::AiConfig>(friendly_thunderbots_config.ai_config()));
}
...
void SimulatedErForceSimPlayTestFixture::setTactic(RobotId id,
                                                   std::shared_ptr<TacticInterface> tactic)
{
    setTactic(id, tactic, {});
}
    ...
    std::set<TbotsProto::MotionConstraint> motion_constraints)
{
    ...
    std::unique_ptr<AssignedTacticsPlay> play =
        std::make_unique<AssignedTacticsPlay>(std::make_shared<TbotsProto::AiConfig>(friendly_thunderbots_config.ai_config()));
