...
void NetworkClient::filterAndPublishVisionData(SSL_WrapperPacket packet)
{
    ...
    if (packet.has_detection())
    {
        ...
        if (!camera_disabled)
        {
            ...
            int friendly_goalie_id = Util::DynamicParameters::AI::refbox::friendly_goalie_id.value();
            ...
            int enemy_goalie_id = Util::DynamicParameters::AI::refbox::enemy_goalie_id.value();
