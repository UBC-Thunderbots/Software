...
class Parameter
{
   public:
    ...
    //     * 'dynamic_reconfigure::Config' msg. The parameter fetches the update from the
    //     update
    ...
    static void registerParameter(Parameter<T>* parameter)
    {
        ...
        //        catch (...)
        //        {
        //            // TODO (Issue #16): Replace with proper exception once exception
        //            handling is
        //            // implemented
    ...
    //    /**
    //     * Takes a list from the dynamic_reconfigure::Config msg and updates the
    //     parameters
