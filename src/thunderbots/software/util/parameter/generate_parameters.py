...
def generate_header_cpp(param_info, output_path):
    ...
    dynamic_parameters_cpp.write(CFG_STR_VECTOR.format(cfg_strs))

    # TODO Add initReconfigureServer function which contains all the servers which # the parmeter server will call
