...
class DirectVelocityPrimitive:public Primitive
{
    ...
    public:
         ...
         * @param x_velocity The robot velocity along x-axis in m/s, positive forward, negative backward
         * @param y_velocity The robot velocity along y-axis in m/s, positive forward, negative backward
         * @param angular_velocity The angular velocity robot has in rad/s, positve clockwise, negative counterclockwise
         * @param dribbler_rpm The dribbler speed in rpm
         */
        explicit DirectVelocityPrimitive(unsigned int robot_id, double x_velocity,double y_velocity,
