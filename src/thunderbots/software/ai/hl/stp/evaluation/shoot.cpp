...
namespace {
    ...
    Evaluation::ShotDirAndScore getBestShotAtSegment(Robot shooter, std::vector<Point> all_obstacles, Segment segment) {
...
namespace Evaluation {
    ...
    ShotDirAndScore getFriendlyRobotBestShotGoal( Robot shooter, std::vector<Point> all_obstacles, Field field ) {
        ...
        return getBestShotAtSegment(shooter, all_obstacles, Segment(field.enemyGoalpostPos(), field.enemyGoalpostNeg()));
    }

    ShotDirAndScore getEnemyRobotBestShotGoal( Robot shooter, std::vector<Point> all_obstacles, Field field ) {

        return getBestShotAtSegment(shooter, all_obstacles, Segment(field.friendlyGoalpostPos(), field.friendlyGoalpostNeg()));
    }
};