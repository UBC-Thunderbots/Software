...
/**
 * The LooseBallTactic will make the assigned robot shoot on the enemy net
 */
class LooseBallTactic : public Tactic
{
   public:
    /**
     * Creates a new LooseBallTactic
     *
     ...
     */
    explicit LooseBallTactic(const Field& field, const Team& friendly_team,
    ...
    /**
     * Updates the parameters for this LooseBallTactic
     *
     * @param field The field being played on
     * @param friendly_team The friendly team
     * @param enemy_team The enemy team
