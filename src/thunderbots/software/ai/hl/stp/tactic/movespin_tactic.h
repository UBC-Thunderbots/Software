...
/**
 * The MovespinTactic will move the assigned robot to the given destination and arrive
...
class MoveSpinTactic : public Tactic
{
   public:
     ...
     */
    explicit MoveSpinTactic(bool loop_forever = false);
   ...
   private:
    ...
    Point destination;
    // The angular velocity the robot should have when it arrives at its destination
