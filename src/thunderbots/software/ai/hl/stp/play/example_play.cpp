...
void ExamplePlay::getNextTactics(TacticCoroutine::push_type &yield)
{
    Timestamp pass_start_time =
        world.ball().lastUpdateTimestamp() + Duration::fromSeconds(5);
    ...
    do
    {
        ...
        //        pass = AI::Passing::Pass(world.ball().position(), {0.5, -0.2}, 5,
        //        pass_start_time); passer->updateParams(pass,
        //        world.ball().lastUpdateTimestamp());
        //        receiver->updateParams(world.friendlyTeam(), world.enemyTeam(), pass,
        //        world.ball()); pass_generator.setWorld(world);
        //        pass_generator.setPasserPoint(world.ball().position());
        //        auto best_pass = pass_generator.getBestPassSoFar();
        //        if (best_pass){
        //            passer->updateParams(*best_pass, world.ball());
        //            receiver->updateParams(world.friendlyTeam(), world.enemyTeam(),
        //            *best_pass, world.ball()); yield({passer, receiver});
        //        } else {
        //            yield({});
        //        }
        //        pass_generator.setWorld(world);
        ...
        //        if (best_pass_opt){
        ////            pass = AI::Passing::Pass(world.ball().position(), {1, -0.0}, 4,
        /// pass_start_time);
        //            pass = *best_pass_opt;
        //            passer->updateParams(pass, world.ball().lastUpdateTimestamp());
        //            receiver->updateParams(world.friendlyTeam(), world.enemyTeam(),
        //            pass, world.ball()); yield({passer, receiver});
        //        } else {
        //            yield({});
        //        }
        //        yield({passer, receiver});
