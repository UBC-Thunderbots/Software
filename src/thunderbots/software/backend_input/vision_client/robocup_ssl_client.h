// This file defines a client that is able to receive packets over UDP multicast
// from SSL-Vision, SSL-Refbox, and grSim
//
...
class RoboCupSSLClient
{
   ...
   public:
    RoboCupSSLClient(int port, string net_ref_address, string net_ref_interface = "");
