...
TEST(DirectVelocityPrimTest, get_robot_id_test)
{
    ...
    DirectVelocityPrimitive direct_velocity_prim = DirectVelocityPrimitive(robot_id, 0.0, 0.0, 0.0, 0.0);
...
TEST(DirectVelocityPrimTest, parameter_array_test)
{
    ...
    DirectVelocityPrimitive direct_velocity_prim =
            DirectVelocityPrimitive(robot_id, x_velocity, y_velocity, angular_velocity,dribbler_rpm);
