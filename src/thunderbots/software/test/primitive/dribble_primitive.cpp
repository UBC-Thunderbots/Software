...
DribblePrimitive dribble_prim = DribblePrimitive(0, Point(), Angle(), 0.0, 0.0, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(robot_id, Point(), Angle(), 0.0, 0.0, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(0, Point(), Angle(), final_speed, 0.0, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(0, Point(), final_angle, 0.0, 0.0, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(0, destination, Angle(), 0.0, 0.0, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(0, Point(), Angle(), 0.0, rpm, false);
...
DribblePrimitive dribble_prim = DribblePrimitive(0, Point(), Angle(), 0.0, 0.0, small_kick_allowed);
...
DribblePrimitive dribble_prim =
        DribblePrimitive(robot_id, destination, final_angle, final_speed, rpm, small_kick_allowed);
