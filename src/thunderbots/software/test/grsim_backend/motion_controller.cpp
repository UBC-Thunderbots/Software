...
TEST_F(MotionControllerTest, calc_correct_velocity_zeros)
{
    ...
    MotionController::Velocity robot_velocities = MotionController::bangBangVelocityController(robot, destination, destination_speed, destination_angle, delta_time);
