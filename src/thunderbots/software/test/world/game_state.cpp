...
INSTANTIATE_TEST_CASE_P(All, GameStateTransitionTest, ::testing::Values(
        ...
        STATE_TRANSITION_PARAMS(STOP, PREPARE_KICKOFF_THEM, PREPARE_KICKOFF_THEM, false, KICKOFF),
        STATE_TRANSITION_PARAMS(STOP, PREPARE_PENALTY_US, PREPARE_PENALTY_US, true, PENALTY),
        STATE_TRANSITION_PARAMS(STOP, PREPARE_PENALTY_THEM, PREPARE_PENALTY_THEM, false, PENALTY),
        ...
        STATE_TRANSITION_PARAMS(STOP, INDIRECT_FREE_THEM, INDIRECT_FREE_THEM, false, INDIRECT)
        ));
