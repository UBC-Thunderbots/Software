...
TEST_F(STPTest, test_get_play_info) {
    ...
    world = ::Test::TestUtil::setFriendlyRobotPositions(world, {Point(0, 0), Point(1, 0)}, Timestamp::fromSeconds(0));
    ...
    expected_play_info.robot_tactic_assignment = {
            "Robot 0  -  Stop Test Tactic",
