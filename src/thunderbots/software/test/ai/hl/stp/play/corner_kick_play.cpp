...
TEST(CornerKickPlayTest, test_example_play_always_applicable)
{
    World world = ::Test::TestUtil::createBlankTestingWorld();

    CornerKickPlay example_play;
    EXPECT_TRUE(example_play.isApplicable(world));
}

TEST(CornerKickPlayTest, test_example_play_invariant_always_holds)
{
    World world = ::Test::TestUtil::createBlankTestingWorld();
...
TEST(CornerKickPlayTest, test_example_play_returns_correct_tactics)
{
    World world = ::Test::TestUtil::createBlankTestingWorld();
