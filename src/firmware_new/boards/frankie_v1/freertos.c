...
void MX_FREERTOS_Init(void) {
  ...
  UbloxOdinTaskHandle = osThreadNew(io_ublox_odinw262_communicator_task, (void *)ublox_communicator, &UbloxOdinTask_attributes);
...
void initIoNetworking()
{
    ...
    ublox_communicator = io_ublox_odinw262_communicator_create(&huart4, ublox_reset_pin);
