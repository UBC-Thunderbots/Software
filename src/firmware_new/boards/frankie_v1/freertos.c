...
#include "shared/proto/tbots_robot_status_msg.nanopb.h"
...
ProtoMulticastCommunicationProfile_t *tbots_robot_status_msg_sender_profile;
...
static TbotsRobotStatusMsg tbots_robot_status_msg;
...
void MX_FREERTOS_Init(void)
{
    ...
    RobotStatusTaskHandle = osThreadNew(io_proto_multicast_sender_task,
                                        (void *)tbots_robot_status_msg_sender_profile,
                                        &RobotStatusTask_attributes);
    ...
    testMsgUpdateHandle =
        osThreadNew(test_msg_update, (void *)tbots_robot_status_msg_sender_profile,
...
void test_msg_update(void *argument)
{
    ...
    for (;;)
    {
        ...
        tbots_robot_status_msg.time_sent.epoch_timestamp_seconds = sys_now();
...
void initIoNetworking()
{
    ...
    tbots_robot_status_msg_sender_profile =
        io_proto_multicast_communication_profile_create(
            "tbots_robot_status_msg_sender", MULTICAST_CHANNELS[channel],
            ROBOT_STATUS_PORT, &tbots_robot_status_msg, TbotsRobotStatusMsg_fields,
