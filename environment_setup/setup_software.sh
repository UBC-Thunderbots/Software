...
# Install Bazelisk. The first time bazel command is ran, the appropriate bazel version will be downloaded
print_status_msg "Installing Bazelisk"
...
print_status_msg "Done Installing Bazelisk"
